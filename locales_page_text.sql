...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (87, 'Eisklammtal stationierten Gebirgsjäger und Söldner (die aus Mitteln bezahlt werden, die der Senat vor meiner Entsendung bereitgestellt hat) kann das Problem meiner Überzeugung nach in kurzer Zeit gelöst werden.$B$BIch habe die Genehmigung von König Bronzebart, alle notwendigen Maßnahmen einzuleiten.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (89, 'überzeugt, dass sie für uns keine ernsthafte Bedrohung darstellen, solange wir uns eben nicht in ihr Revier begeben. Dies mag eine für die zwergische Bevölkerung unangenehme Situation sein, aber in Ermangelung militärischer Ressourcen sollten wir die völlige Vernichtung der Trolle vielleicht einstweilen zurückstellen und uns vielmehr auf die Bedrohung durch die Troggs und die Dunkeleisenzwerge konzentrieren.$B$BAnbei auch ein Bericht meines Bruders Grelin über Ambossar.$B$BGezeichnet$BSenir Weißbart');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (91, 'Eisklammtal stationierten Gebirgsjäger und Söldner (die aus Mitteln bezahlt werden, die der Senat vor meiner Entsendung bereitgestellt hat) kann das Problem meiner Überzeugung nach in kurzer Zeit gelöst werden.$B$BIch habe die Genehmigung von König Bronzebart, alle notwendigen Maßnahmen einzuleiten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (92, 'Mein lieber Tarrel -$Bverzeiht die Hast, mit der diese Zeilen geschrieben sind, aber Zeit ist ein kostbares Gut, das wir uns nicht leisten können.$BDie Grabungsmannschaft hatte bei der Bergung der Titanenartefakte große Fortschritte gemacht. Aber dann stießen wir auch auf andere alte Objekte, insbesondere riesige Knochen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (93, 'Kaum hatten wir die Ersten dieser Knochen gehoben, als wir von Raptoren angegriffen wurden. Das Bataillon aus Langzopfs Regiment kämpfte tapfer. Aber letztlich wurde es überwältigt. Fast alle kamen dabei um. Nur drei von uns überlebten. Ein Hilfsarbeiter namens Ormer Eisenzopf erwies sich dabei als äußerst heldenhaft, denn er rettete sowohl mich als auch Ausgrabungsleiter Whelgar.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (94, 'Wir haben uns einstweilen in eine geschützte Höhle geflüchtet, wo wir wohl in Sicherheit sind. Aber wir sitzen fest, bis Truppen eintreffen, die sich der Raptoren annehmen. Whelgar versucht, die Arbeit fortzusetzen, aber ich befürchte, er hat noch immer recht große Angst. So viel zu unserer Situation, Tarrel. Bitte drängt bei Langzopf auf die sofortige Entsendung eines Rettungstrupps.$BMeine Liebe zu Euch ist auch in diesen schweren Zeiten unvermindert groß.$B- Merrin');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (95, 'Die Grünen Hügel des Schlingendorntals$B$BDafür, dass es unser erster Tag war, lief es heute eigentlich erstaunlich gut. Wir verbrachten einen Großteil der Zeit mit den Vorbereitungen für den Bau eines Stützpunkts. Ich hatte den idealen Ort dafür am Frischwasserzulauf eines Flusses ausgemacht. Den alten verlassenen Docks nach zu urteilen war dieser Ort sogar einmal bewohnt gewesen. Doch die ursprünglichen Bewohner sind längst Geschichte.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (97, 'Die Grünen Hügel des Schlingendorntals$BDafür, dass es unser erster Tag war, lief es heute eigentlich erstaunlich gut. Wir verbrachten einen Großteil der Zeit mit den Vorbereitungen für den Bau eines Stützpunkts. Ich hatte den idealen Ort dafür am Frischwasserzulauf eines Flusses ausgemacht. Den alten verlassenen Docks nach zu urteilen war dieser Ort sogar einmal bewohnt gewesen. Doch die ursprünglichen Bewohner sind längst Geschichte.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (102, 'Nach einem solchen Fehltritt legte Erlgadin Barnil die Hand schwer auf die Schulter. Ajeck und ich schauten beiläufig. Wir dachten, Erlgadin würde Barnil ob seiner Unvorsichtigkeit endlich einmal die Leviten lesen. Aber Erlgadin wies mit einer langsamen Kopfbewegung in Richtung eines umgestürzten Baumes ganz in der Nähe. Zwei stechend schwarze Augen über einem Maul voller rasiermesserscharfer Zähne starrten uns an.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (103, 'Nach einem solchen Fehltritt legte Erlgadin Barnil die Hand schwer auf die Schulter. Ajeck und ich schauten beiläufig. Wir dachten, Erlgadin würde Barnil ob seiner Unvorsichtigkeit endlich einmal die Leviten lesen. Aber Erlgadin wies mit einer langsamen Kopfbewegung in Richtung eines umgestürzten Baumes ganz in der Nähe. Zwei stechend schwarze Augen über einem Maul voller rasiermesserscharfer Zähne starrten uns an.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (105, 'Auf einer felsigen Anhöhe über uns hob sich gegen das Licht der untergehenden Sonne die Silhouette der größten Raubkatze ab, die ich je gesehen habe. Ich gab einen eher unbeholfenen Schuss in Richtung des Tiers ab, das sich davon aber unbeeindruckt zeigte. Die Raubkatze ließ erneut ein Knurren ertönen, lauter noch als beim ersten Mal, und verschwand.$B$BWir packten unsere Sachen und kehrten gut gelaunt ins Lager zurück.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (107, 'Auf einer felsigen Anhöhe über uns hob sich gegen das Licht der untergehenden Sonne die Silhouette der größten Raubkatze ab, die ich je gesehen habe. Ich gab einen eher unbeholfenen Schuss in Richtung des Tiers ab, das sich davon aber unbeeindruckt zeigte. Die Raubkatze ließ erneut ein Knurren ertönen, lauter noch als beim ersten Mal, und verschwand.$BWir packten unsere Sachen und kehrten gut gelaunt ins Lager zurück.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (108, 'Wir hielten uns nach Süden und folgten einigen frischen Pantherspuren. Kurz darauf kamen wir an eine Klamm, die von einer phantastischen Hängebrücke überspannt wurde. Ich musste sofort an Branns eindrucksvolle Beschreibungen des Gebiets denken, als ich dieses technische Wunderwerk sah. Es wurde oft behauptet, die einheimischen Trolle seien primitiv und ungebildet, doch als ich auf dieses handwerkliche Meisterwerk blickte, erkannte ich mit einem Mal das außerordentliche Können, mit dem die Erbauer der Trolle das schier unüberwindliche Hindernis überwunden hatten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (109, 'Wir hielten uns nach Süden und folgten einigen frischen Pantherspuren. Kurz darauf kamen wir an eine Klamm, die von einer phantastischen Hängebrücke überspannt wurde. Ich musste sofort an Branns eindrucksvolle Beschreibungen des Gebiets denken, als ich dieses technische Wunderwerk sah. Es wurde oft behauptet, die einheimischen Trolle seien primitiv und ungebildet, doch als ich auf dieses handwerkliche Meisterwerk blickte, erkannte ich mit einem Mal das außerordentliche Können, mit dem die Erbauer der Trolle das schier unüberwindliche Hindernis überwunden hatten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (110, 'Ajeck und Sire Erlgadin standen unbeweglich und hielten ihre Flinten auf das dichte Buschwerk unter den sanft schwingenden Bäumen gerichtet. Die Mittagssonne brannte auf uns nieder. Ein kleiner Schweißtropfen rann an Erlgadins Schläfe herab, als er den Hahn spannte. In dem Moment, als der Hahn einrastete, teilte sich mit einem Mal das Dickicht und ein großer schwarzer Panther - ein schönes Exemplar - preschte hervor.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (111, 'Ajeck und Sire Erlgadin standen unbeweglich und hielten ihre Flinten auf das dichte Buschwerk unter den sanft schwingenden Bäumen gerichtet. Die Mittagssonne brannte auf uns nieder. Ein kleiner Schweißtropfen rann an Erlgadins Schläfe herab, als er den Hahn spannte. In dem Moment, als der Hahn einrastete, teilte sich mit einem Mal das Dickicht und ein großer schwarzer Panther - ein schönes Exemplar - preschte hervor.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (112, 'Die Büchse ruckte heftig zurück. Er verriss den Schuss seitwärts und geriet mit dem Lauf just unter Ajecks Flinte. Ajeck ihrerseits hatte genau diesen Moment abgepasst, um abzudrücken. Der Schuss verirrte sich irgendwo in die Bäume. Ein Schwarm Vögel flog kreischend aus dem Blätterdach auf und flatterte aufgeregt in alle Himmelsrichtungen davon. Eine Wolke Pulverdampf stieg über einem Baum auf. Fassungslos sahen wir mit an, wie ein gewaltiger Ast geradewegs auf den flüchtenden Panther fiel und ihm das Rückgrat brach.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (113, 'Die Büchse ruckte heftig zurück. Er verriss den Schuss seitwärts und geriet mit dem Lauf just unter Ajecks Flinte. Ajeck ihrerseits hatte genau diesen Moment abgepasst, um abzudrücken. Der Schuss verirrte sich irgendwo in die Bäume. Ein Schwarm Vögel flog kreischend aus dem Blätterdach auf und flatterte aufgeregt in alle Himmelsrichtungen davon. Eine Wolke Pulverdampf stieg über einem Baum auf. Fassungslos sahen wir mit an, wie ein gewaltiger Ast geradewegs auf den flüchtenden Panther fiel und ihm das Rückgrat brach.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (114, 'Wir machten uns beim ersten Tageslicht in Richtung Süden zu den Tkashi-Ruinen auf. Barnil äußerte sich besorgt, dass wir auf Mitglieder des Blutskalpstamms treffen könnten. Ich erinnerte ihn daran, dass die Blutskalpe mehr mit der Vernichtung des verfeindeten Schädelspalterstamms beschäftigt waren. Ich brauche wohl nicht zu betonen, dass Barnil alles andere als beruhigt war. Ich für mein Teil vertraute jedoch auf meine geladene Flinte, einen Ranzen Schießpulver und die drei versierten Jäger neben mir und machte mir keine Gedanken über einen möglichen Hinterhalt.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (115, 'Ich stand vor einer riesigen Höllenbestie auf dem Schlachtfeld und die Armee der Brennenden Legion näherte sich von allen Seiten. Dagegen wirkt eine Bande Trolle so harmlos wie ein Kaninchen in den Hügeln von Dun Morogh.$B$BWir passierten die Tkashi-Ruinen ohne Zwischenfall, worüber insbesondere Barnil sehr erleichtert war. Die Gruppe ging weiter westwärts Richtung Großes Meer und streifte die Ruinen von Zul\'Kunda im Süden. Als wir die Steilküste erklommen, sahen wir ihn: unseren ersten Raptor.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (117, 'Ich stand vor einer riesigen Höllenbestie auf dem Schlachtfeld und die Armee der Brennenden Legion näherte sich von allen Seiten. Dagegen wirkt eine Bande Trolle so harmlos wie ein Kaninchen in den Hügeln von Dun Morogh.$BWir passierten die Tkashi-Ruinen ohne Zwischenfall, worüber insbesondere Barnil sehr erleichtert war. Die Gruppe ging weiter westwärts Richtung Großes Meer und streifte die Ruinen von Zul\'Kunda im Süden. Als wir die Steilküste erklommen, sahen wir ihn: unseren ersten Raptor.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (118, 'Unsere hastig abgefeuerten Schüsse ermöglichten Barnil die Flucht. Barnil stolperte den Hügel wieder hinunter und schloss sich uns erneut an. Wir schlugen uns in den Urwald, wobei das Rudel Schmetterschwanzraptoren jede unserer Bewegungen genau verfolgte.$B$BAus Jägern waren Gejagte geworden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (119, 'Ich führte die Gruppe in Richtung Meer und hoffte, dass wir an der Küste Schutz vor den Raptoren finden würden. Doch in unserer Hast waren wir zu weit nach Norden abgekommen und befanden uns auf einer gefährlich hohen Erhebung. Das war ein Fehler. Und ich war schuld. Plötzlich standen wir vor steil abfallenden Klippen, die Raptoren nur noch ein paar Schritte hinter uns.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (120, 'Ich trat langsam mit erhobener Flinte vor. Ich hatte diese mutigen Jäger ins Verderben geführt. Also wollte ich auch bei ihrer Verteidigung sterben. Schmetterschwanzraptoren sind besonders angriffslustig und bekannt für ihren unstillbaren Blutdurst. Zudem waren sie uns zahlenmäßig weit überlegen. Doch ich wollte verdammt sein, wenn sie mich und meine Kameraden töten könnten, ohne dabei selbst Verluste zu erleiden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (121, 'Ajeck und Sire Erlgadin machten ihre Waffen bereit und gaben mir seitlich Deckung, während wir mit dem Rücken zum Wasser standen. Barnil seufzte ergeben und zog seine Axt. Die Schmetterschwanzraptoren waren schon ganz nah. Sie wurden langsamer. Sie pirschten sich an ihre Beute heran, wussten sie doch, dass wir ihnen nicht mehr entkommen konnten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (152, 'Ajeck und Sire Erlgadin machten ihre Waffen bereit und gaben mir seitlich Deckung, während wir mit dem Rücken zum Wasser standen. Barnil seufzte ergeben und zog seine Axt. Die Schmetterschwanzraptoren waren schon ganz nah. Sie wurden langsamer. Sie pirschten sich an ihre Beute heran, wussten sie doch, dass wir ihnen nicht mehr entkommen konnten.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (365, 'Asterion, ein Magier, bekannt ebenso für seine Beherrschung der arkanen Künste wie für seine körperlichen Fähigkeiten. Er lebte unter dem Volk von Bashal\'Aran und reiste oft nach Ameth\'Aran, um sich um die Belange und Wünsche der Leute zu kümmern.$B$BUnd so begab es sich denn, dass am Ufer des Brunnens der Ewigkeit die Zwillingsstädte wuchsen und gediehen, während die Welt unter den Sternen langsam dem Irrsinn anheim fiel.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (366, 'Gesegnete. Aber nicht alle Hochgeborenen kämpften. Manche standen wie versteinert, vom Wahn ergriffen. Mächtige Städte und kleine Dörfchen fielen um sie herum in Schutt und Asche.$B$BGanz Ameth\'Aran war zerstört und seine Bewohner warfen sich voller Angst zu Boden, als würden sie dadurch verschont. Da begab es sich, dass Athrikus Narassin, der Liebling von Azshara, erschien, um sie in Sicherheit zu bringen.$B$BEr könne sie mit einem Zauber schützen, sagte er. Während um sie herum Bruder und Schwester, Vater und Mutter verschwanden,');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (367, 'würden sie ewig leben und von der kommenden Teilung nichts zu befürchten haben...');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (371, 'L. F. hat mehr Aggression gegen die Narren der Allianz angeordnet. Es folgt eine Liste mit Materialien, die für eine wichtige Mission gegen Süderstade benötigt werden:$BReiserationen für 20 Männer und 1 Woche$B20 schwarze Nachtanzüge$B20 Paar neue Schuhe$B25 neue Schwerter$B30 Wurfmesser$B20 schwarze Masken$B10 Phiolen mit brennbarem Öl$B50 Dosen lähmendes Gift$BWenn möglich 5 gestohlene Uniformen der Wachen von Süderstade$B100 Silbermünzen$B- Baron V.$BRüstmeister');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (372, 'Der Stern von Xil\'yeh$BGrelborg der Horter hat den Stern. Er ist ein gieriger Oger, der seine Tage im Alteracgebirge und in den Ruinen von Alterac verbringt und dort nach Schmuckstücken sucht. Die meisten seiner Stücke sind nutzlos, aber dieses eine, der Stern von Xil\'yeh, hat wertvolle Eigenschaften.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (373, 'Die Hand von Dagun$BIn den alten Schriften heißt es, die Krallen von Dagun sonderten ein Gift ab, das die Beute nicht tötet, sondern sie in etwas anderes verwandelt - etwas, das zu den alten Völkern gehört. Der Wert der Hand für uns steht außer Frage.$BDagun lebt draußen im offenen Meer, wird aber regelmäßig von den Murlocs des Schlammflossenstamms in den Düstermarschen an die Oberfläche getrieben. Ihre Orakel beschwören ihn mit verzaubertem Seetang. Wenn Ihr genügend Orakel tötet, findet Ihr auch den Tang. Diesen legt Ihr dann auf den Altar der Murlocs und Dagun wird erscheinen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (374, 'Das Herz des Vermächtnisses$BMogh der Unsterbliche ist ein Trollhexendoktor im Schlingendorntal. Er ist im Besitz des Herzens des Vermächtnisses, von dem es heißt, es hielte den Tod von jenen fern, die seine Geheimnisse lüften können. Ihr findet Mogh in den Ruinen von Zul\'Mamwe. Besiegt ihn und bringt mir das Herz des Vermächtnisses.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (375, 'Bringt mir diese drei Dinge - den Stern, die Hand und das Herz - und \'Yagyins Zusammenstellung\' ist Euer.$B- G.K.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (376, 'Der Stern von Xil\'yeh$B  $BEin Oger in Alterac, Grelborg der Horter, ist der letzte bekannte Besitzer dieses Edelsteins, von dem gemunkelt wird, dass er seinen Besitzer befähigt, mit anderen Welten zu kommunizieren. Unseren Quellen zufolge streift Grelborg durch die Ruinen von Alterac im Alteracgebirge, wo er im Geröll und Trümmern nach weiteren alten Relikten sucht.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (377, 'Die Hand von Dagun$B$BDagun ist ein Wasserwesen, das von den Murlocs in den Düstermarschen angebetet wird. Sie locken ihn mit einer speziellen Art Seetang, den ihre Schamanen verzaubert haben, an die Oberfläche. Jagt diese Murlocs, holt mir den verzauberten Seetang und legt ihn auf den Altar der Murlocs! Dagun wird kommen, und Ihr werdet ihn erwarten.$B$BIch will diese Hand.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (378, 'Das Herz des Vermächtnisses$B$BIn alten Schriften heißt es, wer das Herz des Vermächtnisses besitzt, fürchtet kein Grab. Das ist vielleicht sogar wahr, denn der Besitzer des Herzens, der Troll Mogh, ist unter dem Namen Mogh der Unsterbliche bekannt. Mogh ist ein Hexendoktor vom Schädelspalterstamm. Er lebt im Schlingendorntal in den Ruinen von Zul\'Mamwe.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (379, 'Bringt mir diese drei Dinge - den Stern, die Hand und das Herz - und eine Kopie von \'Yagyins Zusammenstellung\' ist Euer.$B$B- Der Bewahrer');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (380, 'Todespirschermissionsbericht$B$BAgenten: Rane Yorick, Quinn Yorick, Erland McKree$B$BPrimärmission: Aufklärung im nördlichen Silberwald und Einschätzung der Bedrohung sowohl durch Wildtiere als auch die Geißel.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (381, 'Die Agenten begannen mit der Durchsuchung und stießen auf zahlreiche Worgs. Ich empfehle Jagdtrupps zur Reduzierung der Bedrohung.$B$BUntote Gnolle wurden in der Bauernsiedlung mit Namen \"Das Todesfeld\" gesichtet. Was sie dort tun, ist unklar, aber ihre Bewegungen und ihre ständige Bereitschaft lassen auf etwas Militärisches schließen. Im Beobachtungszeitraum wurden keine bedeutenden Anführer der Gnolle gesichtet. Wir gehen daher davon aus, dass sie auf das Eintreffen ihrer Anführer oder Verstärkung warten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (382, 'Im Zuge der Aktion wurden unsere Agenten auf Ivars Hof eingeschlossen. Ivar, der Großteil seiner Familie und Tagelöhner hatten sich der Geißel unterworfen und waren nun ihre Diener.$B$BUnsere Agenten wurden angegriffen. Zwar konnten sie sich der Attacken erwehren, aber sie erlitten dabei schwere Verletzungen, insbesondere Agent Quinn.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (383, 'Wir bezogen Verteidigungsstellung in Ivars altem Haus. Rane hielt Wache wegen möglicher weiterer Angriffe und Erland setzte die Aufklärungsmission fort.$B$BDann wurde Erland von Worgs in einem Obsthain im Norden eingekesselt und konnte nur mit Hilfe eines weiteren Agenten der Verlassenen entkommen. Diesen Agenten habt Ihr gerade vor Euch.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (386, 'An dieser Stelle soll vermerkt werden, dass der Überbringer dieses Berichts nicht nur maßgeblichen Anteil am Gelingen unserer Mission hatte, sondern auch am Sieg über Ivar den Verräter und an der Rettung Erlands sowie an der Zustellung dieses Berichts.$B$BWir erbieten unseren Dank und empfehlen, dass das Kommando der besagten Person die Belohnung angedeihen lassen möge, die solch vorbildlichem Verhalten im Einsatz angemessen ist.$B$B- Todespirscher Rane Yorick,$BMissionsleiter');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (387, 'Und so wanderte er denn umher und suchte. Sein Arm jedoch blieb verloren. Und so ging er fluchend und brüllend seines Wegs.$BAber Gri\'lek hatte sich vor langer Zeit von den Geistern abgewandt und sie so verärgert. Nun hörten sie nicht mehr auf sein Fluchen.$BGri\'lek war verdammt, verdammt dazu, mit nur einem Arm umherzuwandern.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (393, 'Und so wanderte er denn umher und suchte. Sein Arm jedoch blieb verloren. Und so ging er fluchend und brüllend seines Wegs.$BAber Gri\'lek hatte sich vor langer Zeit von den Geistern abgewandt und sie so verärgert. Nun hörten sie nicht mehr auf sein Fluchen.$BGri\'lek war verdammt, verdammt dazu, mit nur einem Arm umherzuwandern.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (394, 'Ein böser Magier hat dies erschaffen,$BUm vom Glutnebelgipfel auf dich zu gaffen,$BEr dich und deinen Freund verlacht,$BIhr müsst zerbrechen seine Macht,$B$BAllein der Tod stoppt seine Wut,$BDrum geht und löschet seine Glut!');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (395, 'Der Schrein von Mel\'Thandris$B$B\"Möge das Licht von Elune auf ewig dieses Tal bescheinen und beleuchten die Wege des Waldes, wie es dies schon seit Anbeginn der Zeiten getan hat.\"');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (396, 'Elune hat mir meine Wünsche gewährt. Meine Kameraden haben ihr Leben nicht umsonst gelassen und ich werde ihren Tod mit der Sense von Elune rächen. Diese Sense ist ein altes Ding - ein Ast, gewunden und knorrig und aus einem Holz, das älter noch sein könnte als die Kaldorei.$BViele Stunden habe ich dies Geschenk der Göttin begutachtet. Eine gewöhnliche Waffe ist es nicht, so viel ist sicher. Aber ein einfacher magischer Gegenstand ist es auch nicht. Damit... ist es, als verschwömmen die Barrieren von Raum und Zeit.$BAls ich die Sense...');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (397, 'in Händen hielt, hatte ich eine Vision des Chaos. Die Wolfsmenschen... die Worgen... kämpften gegen einen unglaublichen Feind. Die Worgen kämpften mit der ihnen eigenen Wildheit, aber den Feind schreckte das nicht. Es waren die Lords der Smaragdgrünen Flamme.$BDa begriff ich die wahre Macht der Sense. Wenn ich mich auf sie konzentrierte, konnte ich in Worgen reden. Doch redete ich nicht in Worten mit ihnen. Es war etwas anderes... Ich wüsste es nicht zu beschreiben.$BDas Entscheidende war, dass mich die Worgen hörten');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (398, 'und verstanden. Ich leitete mehr Energie in die Sense und die Barrieren wurden schwächer. Ich konnte Worgen in unsere Welt ziehen. Dreißig Worgen konnte ich bei meinem ersten Versuch beschwören. Sie folgten mir in den Kampf und mit ihrer rohen Kraft unter meinem Kommando fielen wir über die Dämonen im Teufelswald her.$BElune hat meine Wünsche erhört. Der Wald wird gesäubert werden.$BMöge Elunes Segen mir hold sein, bis meine Arbeit getan ist.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (636, 'Wie es scheint, konnten die Helden das Portal zerstören und Azeroth retten - doch bleibt abzuwarten, ob sie dem Todeskampf von Draenor zu entkommen vermochten oder nicht.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (750, '<HTML>\n<BODY>\n<BR/>\n<BR/>\n<H1 align=\"center\">\nEliza\n</H1>\n<BR/>\n<BR/>\n<BR/>\n<BR/>\n<P align=\"center\"Mein Geliebtes Weib. Möge die Erde dein Hunger stillen.</P>\n</BODY>\n</HTML>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (751, 'Hier sind die Maße für den Kolben:$BLänge: 32 BHB$BBreite: 12 BHB$BGewicht: 23,5 KKG bis 25,5 KKG$BZündung: 70 ZL$BSchubkraft: Mindestens 98$BVerdichtungsrate: Super-Derb oder höher$BFalls Euch Gnomenmaße nicht mehr geläufig sind:$BBHB = Barthaaresbreite$BKKG = Klitzekleine Gramm$BZL = Zehenlocken');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (752, 'Ja, Mann. Ihr bringen diesen Brief zu Frang in Tal der Prüfungen. Er meist vor dem Bau und peitschen junge Krieger zurecht, sodass kämpfen können für Horde.$B$BEr brauchen schlaue Krieger wie Euch, um Orcs zu zeigen, dass Kämpfen auch anders geht, nicht nur mit Muskelns. Ihr schneller und schlauer als die meisten seid, aber damit lieber nicht prahlen - Orcs nehmen Beleidigung nicht auf leichtige Schulter. Sie gute Verbündete werden sein und vielleicht Euch auch lehren das eine oder das andere.$B$B- Tar\'sere');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (770, 'Ja, Mann. Ihr bringen diesen Brief zu Frang in Tal der Prüfungen. Er meist vor dem Bau und peitschen junge Krieger zurecht, sodass kämpfen können für Horde.$B$BEr brauchen schlaue Krieger wie Euch, um Orcs zu zeigen, dass Kämpfen auch anders geht, nicht nur mit Muskelns. Ihr schneller und schlauer als die meisten seid, aber damit lieber nicht prahlen - Orcs nehmen Beleidigung nicht auf leichtige Schulter. Sie gute Verbündete werden sein und vielleicht Euch auch lehren das eine oder das andere.$B$B- Tar\'sere');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (771, 'FÜTTERUNG UND PFLEGE:$B$BUnser Ziel ist es, Euch alles zu liefern, was Ihr für die Pflege Eures Tieres braucht. Dieses hohe Niveau erwarten die Kunden der Schnüffel AG und es ist unser höchstes Ziel!$B$BZu diesem Zweck haben wir stabile Zieselkisten mit Luftlöchern gebaut, perfekt um Euer Tier sicher zu transportieren und vor Licht zu schützen.$B$BJede Kiste enthält einen Futterbehälter mit dem betörenden Duft von Blaulaubknollen (dem Lieblingsfutter des Schnüffelnasenziesels)!');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (790, 'FÜTTERUNG UND PFLEGE: Unser Ziel ist es, Euch alles zu liefern, was Ihr für die Pflege Eures Tieres braucht. Dieses hohe Niveau erwarten die Kunden der Schnüffel AG und es ist unser höchstes Ziel! Zu diesem Zweck haben wir stabile Zieselkisten mit Luftlöchern gebaut, perfekt um Euer Tier sicher zu transportieren und vor Licht zu schützen. Jede Kiste enthält einen Futterbehälter mit dem betörenden Duft von Blaulaubknollen (dem Lieblingsfutter des Schnüffelnasenziesels)!');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (791, 'Ich werde Euch die Umgebung so beschreiben, wie sie die Späher von Kargath mir beschrieben haben:$B- rote, felsige Hügel und trockene Ebenen, die sehr lebensfeindlich sind;$B- brennende Sonne und scharfer Wind;$B- keine Seen oder Flüsse, nicht mal Pfützen oder Tümpel. Wasser finden die dortigen Bewohner allenfalls in tiefen, schlammigen Brunnen oder indem sie das bisschen Feuchtigkeit aus den seltenen Kakteen oder stacheligen Gräsern saugen.$BKurz gesagt: Es ist ein heißes und hartes Leben.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (792, 'Das Ödland ist voller Feinde. Oger durchstreifen den glühend heißen Sand und lauern den Unvorsichtigen auf. Dunkeleisenzwerge leben in einer Kaserne östlich von Kargath und bekämpfen ihre hellhäutigeren Verwandten vom Loch Modan im Norden. Brutale, primitive Wesen mit der Bezeichnung Troggs nehmen jeden noch so kleinen schattigen Fleck für sich in Anspruch und verteidigen ihn verbissen.$BUnd in der Lethlorklamm im östlichen Ödland hausen Großdrachen. Wir wissen nicht, wie viele es sind und wie groß sie sind, da keiner der Späher, die sich zu nahe herangetraut haben, zurückgekommen ist.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (793, 'Unnötig zu sagen, dass wir - die Belegschaft der Garnison von Kargath - froh sind über unseren Auftrag. Hier bleiben wir hart, denn wenn wir verweichlichen, sterben wir.$BAnders würde ich es auch gar nicht wollen.$BNeeka Blutnarbe$BHauptspäher von Kargath');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (794, 'Unsere Welt ist reich an Geschichte. Die Geschichte alter und neuer Völker. Die Geschichte von längst vergangenen Kriegen und solchen, die noch andauern.$BDie Geschichte von Göttern, die aus dem Himmel herabstiegen. Und die Geschichte älterer Götter, die in der Erde schlafen.$BIch spreche nun von jenen Wesen - den Alten Göttern. Sie lebten und wüteten in Azeroth, als die Welt neu war.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1051, 'Die Wachen dieses Turms scheinen besonders anfällig für meine Angriffe. Als ich die Rückseite des Turms erkundete, sah mich ein Patrolleur und griff an. Ich konnte die Wache mühelos mit einem rechtzeitigen Schlag in den Solarplexus und einem anschließenden Meuchelangriff besiegen.$B$BIch wartete versteckt auf ihren Partner, der kam, um den Grund der Aufregung zu untersuchen. Der Patrolleur kam zu den Büschen, wo ich den Leichnam hingezerrt hatte, und begann zu suchen. Langsam und vorsichtig schlich ich hinter ihn, damit mein Hinterhalt nicht entdeckt würde.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1052, 'Als sich die Gelegenheit bot, stieß ich ihm den Dolch in den Rücken! Seine Lungen versagten den Dienst und er fiel mit einem dumpfen Aufschlag zu Boden.$B$BDer Angriff aus dem Hinterhalt war so schnell und brutal, dass der arme Kerl nicht mal Zeit zu schreien hatte. Als ich die Klinge herauszog, entwich dem durchbohrten Patrolleur seltsamerweise ein übler Gestank.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1053, 'Es scheint, als hätte das, was Klaven in seiner Truhe verschlossen hat, ungünstige Auswirkungen auf die Bewohner des Turms. Ich vermute, andere Wachen haben ähnliche Schwächen. Womöglich wurde selbst Klaven Opfer der Ablagerungen.$B$BAgentin Amber Kearnen$BSI:7 Basisagentin, R8');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1071, 'Kommandant,$B$Bzurückkehren nach Orgrimmar. Streitkräfte unzureichend. Müssen unsere Position mit neuen Informationen reanalysieren.$B$BGroße Anzahl von Schattenanbetern und Ogern präsent. Dämonen bewachen das Dunkle Portal.$B$B- Thrall, Kriegshäuptling der Horde');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1090, 'Es scheint, als hätte das, was Klaven in seiner Truhe verschlossen hat, ungünstige Auswirkungen auf die Bewohner des Turms. Ich vermute, andere Wachen haben ähnliche Schwächen. Womöglich wurde selbst Klaven Opfer der Ablagerungen. Agentin Amber Kearnen SI:7 Basisagentin, R8');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1091, 'Der Schlaghammer von Zul\'Farrak$B$BUm den Schlaghammer von Zul\'Farrak herzustellen, muss man zuerst zum Altar von Zul reisen und einem Trollbewahrer den hochheiligen Schlaghammer abknöpfen.$B$BDann muss man den hochheiligen Schlaghammer zum Altar auf dem höchsten Punkt der Trollstadt Jintha\'Alor bringen.$B$BBenutzt man den hochheiligen Schlaghammer an dem Altar, so erfüllt man ihn mit Macht und verwandelt ihn in den Schlaghammer von Zul\'Farrak.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1130, 'Der Schlaghammer von Zul\'Farrak Um den Schlaghammer von Zul\'Farrak herzustellen, muss man zuerst zum Altar von Zul reisen und einem Trollbewahrer den hochheiligen Schlaghammer abknöpfen. Dann muss man den hochheiligen Schlaghammer zum Altar auf dem höchsten Punkt der Trollstadt Jintha\'Alor bringen. Benutzt man den hochheiligen Schlaghammer an dem Altar, so erfüllt man ihn mit Macht und verwandelt ihn in den Schlaghammer von Zul\'Farrak.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1131, 'SUPER-KRITISCHE DREIFACH-CODIERTE DATENKARTE$B01000100 01100001 01110011 00100000 01101001 01110011 01110100 00100000 01101011 01100101 01101001 01101110 00100000 01001101 01101111 01101110 01100100 00101100 00100000 01100100 01100001 01110011 00100000 01101001 01110011 01110100 00100000 01100100 01101001 01100101 00100000 01000110 01100101 01110011 01110100 01110101 01101110 01100111 00100000 01100100 01100101 01110010 00100000 01010011 01110100 11111100 01110010 01101101 01100101 00101110');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1150, 'SUPER-KRITISCHE DREIFACH-CODIERTE DATENKARTE 01000100 01100001 01110011 00100000 01101001 01110011 01110100 00100000 01101011 01100101 01101001 01101110 00100000 01001101 01101111 01101110 01100100 00101100 00100000 01100100 01100001 01110011 00100000 01101001 01110011 01110100 00100000 01100100 01101001 01100101 00100000 01000110 01100101 01110011 01110100 01110101 01101110 01100111 00100000 01100100 01100101 01110010 00100000 01010011 01110100 11111100 01110010 01101101 01100101 00101110');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1151, 'Die Venture Company <unleserlicher Text> Es scheint, als hätten die Narren fast ihre gesamte Anlage vernichtet, als sie die Mixtur stabilisieren wollten.$B$B<mehrere Seiten wurden scheinbar herausgerissen>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1152, 'Mir fiel auf, dass die Ablagerung extrem tödlich ist. Man stelle sich vor <unleserlicher Text> Ha-ha-ha!');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1153, 'Verliere ich den Verstand? Heute enthauptete ich einen meiner treuesten Patrolleure, um einen Blick auf seine Seele werfen zu können. Als ich in die durchgetrennte Luftröhre sah, fiel mir ein: Ich hatte seit Tagen nichts mehr gegessen!');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1154, 'Mathias Shaw hat eine Botin geschickt, mich zu töten. <unleserlicher Text>\n$BSie patrouilliert jetzt draußen. Hirnlose, leblose Drohne.$B$BHahahah!');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1155, 'Van Cleef... <unleserlicher Text>\n$BRuft mich REIN??? FÜR WEN HÄLT DER SICH??? Ich bin Klaven Jagdruf! Ich lasse mir von keinem Insekt vorschreiben, was ich zu tun habe!$B$B<Die restlichen Seiten des Buches fehlen>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1156, 'Curgle,$B$Bich warte schon voller Ungeduld auf Eure neueste Erfindung. Ich kann es kaum erwarten, sie zu benutzen, um damit meine Studien zu dokumentieren.$B$BBitte vertraut sie meinem Boten an.$B$B$BMit herzlichen Grüßen,$B$BDaryn Leuchtwind');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1170, 'Curgle,$Bich warte schon voller Ungeduld auf Eure neueste Erfindung. Ich kann es kaum erwarten, sie zu benutzen, um damit meine Studien zu dokumentieren.$BBitte vertraut sie meinem Boten an.$BMit herzlichen Grüßen,$BDaryn Leuchtwind');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1392, 'Bruder Neals,$Bmeine Trauben sind gerettet! $N, der Überbringer dieses Manifests, wagte sich in meinen von Rohlingen überrannten Weinberg und holte die Trauben, da ich es nicht konnte. Zwar kommen die Defias immer noch über den Fluss, aber fast meine gesamte Ernte wurde eingebracht.$BIhr könnt Euren Vorräten eine volle Ladung Trauben hinzufügen.$BMöge das Licht uns beschützen.$B- Milly Geltmark');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1430, 'Bruder Neals,$B$Bmeine Trauben sind gerettet! $N, der Überbringer dieses Manifests, wagte sich in meinen von Rohlingen überrannten Weinberg und holte die Trauben, da ich es nicht konnte. Zwar kommen die Defias immer noch über den Fluss, aber fast meine gesamte Ernte wurde eingebracht.$B$BIhr könnt Euren Vorräten eine volle Ladung Trauben hinzufügen.$B$BMöge das Licht uns beschützen.$B- Milly Geltmark');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1431, 'Vorfalk Irongourd$B$BVorfalk arbeitet im Lagerraum des \'Grimmigen Säufers\'. Sein Opfer für die Dunkelbewahrer ist groß.$B$BMöge sein Geist standhalten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1432, 'Bethek Sturmbraue$B$BBetheks Wanderungen führen ihn tief hinein nach Schwarzfels. Die Geheimnisse des Berges locken ihn.$B$BMöge sein Geist niemals schwach werden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1433, 'Uggel Hammerhand$B$BUggel ist ein kunstfertiger und gewissenhafter Steinmetz. Wenn er nicht die Bürde des dunklen Schlüssels trägt, entstehen unter seinen Händen in der Halle des Handwerks wahre Meisterwerke.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1434, 'Zimrel Darktooth$B$BWenn der Wahnsinn des dunklen Schlüssels über Zimrel kommt, können ihn nur die Schreie der Sterbenden besänftigen.$B$BFür sein Opfer wird er stets eine Sitzbank über der Arena haben. Möge unser blutiges Spektakel die Wut seines Herzens beschwichtigen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1435, 'Ofgut Steinfaust$B$BZahllos sind jene, die Dunkelbewahrer Ofguts Hammer zum Opfer fielen.$B$BDie Soldaten der Westgarnison verneigen sich ehrfürchtig, wenn er vorübergeht. Denn wer von ihnen kann in Ofguts Augen schauen und die Geheimnisse sehen, die der dunkle Schlüssel flüstert?');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1436, 'Pelver Deepstomp$B$BDunkelbewahrer Pelver ist unser am höchsten verehrter Jünger. Er hat den Schlüssel länger getragen als jeder andere, und das unter enormen Opfern. Wenn er zu seiner Bürde gerufen wird, so wird er im Domizil bewacht.$B$BSein Opfer wird gewürdigt und er wird viele Jahre in unseren Herzen weiterleben... nachdem die Dunkelheit ihn geholt hat.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1470, 'Pelver Deepstomp$B$BDunkelbewahrer Pelver ist unser am höchsten verehrter Jünger. Er hat den Schlüssel länger getragen als jeder andere, und das unter enormen Opfern. Wenn er zu seiner Bürde gerufen wird, so wird er im Domizil bewacht.$B$BSein Opfer wird gewürdigt und er wird viele Jahre in unseren Herzen weiterleben... nachdem die Dunkelheit ihn geholt hat.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1471, 'Solomon,$B$Bder Überbringer dieses Dekrets hat den offiziellen Status eines Stellvertreters von Sturmwind erlangt. Ihr könnt ihn benutzen, um einen Beweis dafür zu finden, dass der schwarze Drachenschwarm sich mit den Orcs des Schwarzfelsklans eingelassen hat. Sollte so ein Beweis gefunden werden, soll dieser Stellvertreter besagten Beweis zu mir nach Sturmwind bringen, woraufhin ich den Befehl erteilen werde, hinreichend Militär zur Unterstützung von Seenhain zu entsenden.$B$BHochachtungsvoll$B$B$B$BHochlord Bolvar Fordragon');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1490, 'Solomon,$B$Bder Überbringer dieses Dekrets hat den offiziellen Status eines Stellvertreters von Sturmwind erlangt. Ihr könnt ihn benutzen, um einen Beweis dafür zu finden, dass der schwarze Drachenschwarm sich mit den Orcs des Schwarzfelsklans eingelassen hat. Sollte so ein Beweis gefunden werden, soll dieser Stellvertreter besagten Beweis zu mir nach Sturmwind bringen, woraufhin ich den Befehl erteilen werde, hinreichend Militär zur Unterstützung von Seenhain zu entsenden.$B$BHochachtungsvoll$B$B$B$BHochlord Bolvar Fordragon');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1914, 'Die Zwerge von Eisenschmiede lebten lange Jahre in Frieden. Aber ihre Gesellschaft wurde zu groß für die Enge ihrer Bergstädte. Der mächtige Hochkönig Modimus Ambossar regierte die Zwerge zwar gerecht und weise, doch in der Gesellschaft der Zwerge waren drei starke Fraktionen entstanden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1915, 'Der Bronzebartklan, der von Than Madoran Bronzebart beherrscht wurde, stand treu zum Hochkönig und stellte die traditionellen Verteidiger von Eisenschmiede. Der Wildhammerklan unter Than Khardros Wildhammer bewohnte die Vorgebirge und Felsspalten am Fuß des Berges und strebte nach mehr Einfluss in der Stadt.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1916, 'Die dritte Fraktion, der Dunkeleisenklan, wurde von dem Zaubererthan Thaurissan beherrscht. Die Dunkeleisenzwerge verbargen sich in den dunkelsten Schatten unter dem Berg und schmiedeten Ränke gegen den Bronzebart- und Wildhammerklan.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1917, 'Eine Zeit lang wahrten die drei Fraktionen einen brüchigen Frieden, doch als Hochkönig Ambossar in hohem Alter verschied, kam es zu offenen Spannungen. Die drei herrschenden Klans entfesselten einen Krieg um die Herrschaft über Eisenschmiede. Viele Jahre tobte der Bürgerkrieg der Zwerge unter der Erde. Schließlich trieben die Bronzebärte, die über das größte stehende Heer verfügten, die Dunkeleisenzwerge und Wildhämmer in die Verbannung.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1918, 'Khardros und seine Wildhammerkrieger zogen durch die Barrierentore von Dun Algaz nach Norden und gründeten auf dem fernen Gipfel Grim Batol ihr eigenes Reich. Dort erlebten die Wildhämmer eine Blütezeit und konnten ihre Schatzkammern wieder füllen. Mit Thaurissan und seinen Dunkeleisenzwergen meinte es das Schicksal nicht so gut. In ihrer Verbitterung und Wut nach der Niederlage schworen sie Eisenschmiede Rache. Thaurissan führte sein Volk weit in den Süden, wo sie im malerischen Rotkammgebirge eine Stadt gründeten (der er seinen eigenen Namen gab).');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1919, 'Der über viele Jahre hinweg angehäufte Wohlstand ließ die Dunkeleisenzwerge den Groll gegen ihre Vettern nicht vergessen. Auch die lange seit damals vergangene Zeit half nicht, die Herzen zu erweichen. Thaurissan und sein Weib, die Zauberin Modgud, begannen Feldzüge gegen Eisenschmiede und Grim Batol. Die Dunkeleisenzwerge wollten ganz Khaz Modan für sich beanspruchen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1920, 'Die Armeen der Dunkeleisenzwerge rückten gegen ihre Vettern vor und hätten um ein Haar die Festungen beider Königreiche vernichtet. Schlussendlich jedoch führte Madoran Bronzebart seinen Klan zu einem entscheidenden Sieg über Thaurissans Armee von Zauberern. Thaurissan und seine Diener flohen zurück in ihre sichere Stadt und ahnten nichts von den Geschehnissen in Grim Batol, wo es Modguds Armee nicht besser gegen Khardros und seine Wildhammerkrieger erging.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1921, 'Als Modgud gegen die feindlichen Krieger vorrückte, wandte sie ihre Kräfte an, um Furcht in ihren Herzen zu säen. Schatten folgten ihrem Gebot, dunkles Getier kroch aus den Tiefen der Erde empor und jagte die Wildhämmer in ihren eigenen Hallen. Schließlich durchbrach Modgud die Tore und belagerte die Festung selbst. Die Wildhämmer kämpften verzweifelt, Khardros selbst schritt durch das Schlachtengetümmel, um die Zauberin und Königin zu erschlagen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1922, 'Als ihre Königin gefallen war, flohen die Dunkeleisenzwerge vor der Wut der Wildhämmer. Sie eilten nach Süden zur Festung ihres Königs, trafen unterwegs jedoch auf die Armeen von Eisenschmiede, die zur Unterstützung von Grim Batol gekommen waren. Die verbliebenen Streitkräfte der Dunkeleisenzwerge wurden zwischen den beiden Armeen aufgerieben und vollkommen vernichtet.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1953, 'Kil\'jaeden wusste, dass die Klans der Orcs fast bereit waren, musste aber ihrer uneingeschränkten Loyalität sicher sein. Im Geheimen ließ er den Schattenrat Mannoroth den Zerstörer beschwören, die lebende Inkarnation von Zerstörung und Wut. Gul\'dan rief die Häuptlinge aller Klans zusammen und redete ihnen ein, dass Mannoroths tosendes Blut sie ganz und gar unverwundbar machen würde.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1954, ' Auf Betreiben von Grom Höllschrei tranken alle Klanhäuptlinge, ausgenommen Durotan, und besiegelten damit ihr Schicksal als Sklaven der Brennenden Legion. Darüber hinaus dehnten die ahnungslosen, von Mannoroths Wut angesteckten Häuptlinge diese Unterwerfung auf ihre ahnungslosen Brüder aus.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1955, 'Die Orcs wurden vom Fluch dieses neuen Kampfrauschs verzehrt und wollten ihre Wut an jedem auslassen, der sich ihnen in den Weg stellte. Gul\'dan spürte, dass seine Zeit gekommen war, und vereinigte alle rivalisierenden Klans zu einer einzigen unaufhaltbaren Horde.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1956, 'Wohl wissend, dass einige Häuptlinge wie Höllschrei und Orgrim Schicksalshammer nach Alleinherrschaft trachten würden, ernannte Gul\'dan einen Kriegshäuptling, der als sein Handlanger über diese neue Horde gebieten sollte. Schwarzfaust der Zerstörer, ein besonders verrohter und tückischer Kriegsherr der Orcs, sollte Gul\'dans Marionette sein. Unter dem Befehl von Schwarzfaust ging die Horde gegen die einfältigen Draenei vor.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1957, 'Im Lauf weniger Monate rottete die Horde fast alle Draenei aus, die auf Draenor lebten. Nur eine Hand voll verstreute Überlebende konnten dem alles vernichtenden Zorn der Orcs entrinnen. Gul\'dan berauschte sich an seinem Sieg und pries Macht und Kraft der Horde. Aber er wusste, ohne Gegner würde die Horde in ihrer nicht enden wollenden Gier nach ruhmreichen Siegen sich selbst mit endlosen internen Kämpfen zerfleischen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1958, 'Kil\'jaeden wusste, dass die Horde endlich bereit war. Die Orcs waren die stärkste Waffe der Brennenden Legion geworden. Der listenreiche Dämon gab diese Erkenntnis an seinen wartenden Meister weiter, worauf auch Sargeras zustimmte, dass die Zeit endlich reif wäre für seine Rache.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1959, 'Während Kil\'jaeden die Horde für die Invasion von Azeroth vorbereitete, kämpfte Medivh weiter gegen Sargeras um seine Seele. König Llane, der edle Monarch von Sturmwind, beobachtete die Dunkelheit, die den Geist seines ehemaligen Freundes zu besudeln schien, mit wachsendem Misstrauen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1960, 'König Llane weihte Anduin Lothar, den letzten Nachfahren des Geschlechts der Arathi, den er seinen Waffenoffizier nannte, in seine Befürchtungen ein. Doch keiner der Männer konnte auch nur im Geringsten ahnen, welche Schrecken Medivhs langsamer Abstieg in den Wahnsinn wirklich mit sich bringen würde.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1961, 'Als letztes Lockmittel versprach Sargeras, dass er Gul\'dan große Macht verleihen würde, sollte er einwilligen, die Horde nach Azeroth zu führen. Durch Medivh teilte Sargeras dem Hexenmeister mit, dass er zu einem lebenden Gott werden könne, sollte er das unterseeische Grabmal finden, in dem die Wächterin Aegwynn vor fast tausend Jahren den verstümmelten Körper von Sargeras begraben hatte.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1962, ' Gul\'dan willigte ein und beschloss, dass er das legendäre Grab finden und seine Belohnung einfordern würde, sobald die Bewohner von Azeroth unterworfen waren. Sargeras war sich nun sicher, dass die Horde seinen Zwecken dienen würde, und gab den Befehl zum Beginn der Invasion.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1963, 'Unter gemeinsamer Aufbietung aller Kräfte öffneten Medivh und die Hexenmeister des Schattenrats das Dimensionstor, das als Dunkles Portal bekannt ist. Dieses Portal überbrückte die Distanz zwischen Azeroth und Draenor und war groß genug, dass ganze Armeen es passieren konnten. Gul\'dan schickte Späher der Orcs durch das Portal, damit sie die Länder, die sie erobern sollten, ausspähen konnten. Als die Späher zurückkehrten, versicherten sie dem Schattenrat, dass die Welt Azeroth reif für die Eroberung sei.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1964, 'Durotan war freilich immer noch der festen Überzeugung, dass Gul\'dans Verderbnis den Untergang seines Volkes bedeuten würde, und stellte sich abermals gegen die Hexenmeister. Der tapfere Krieger behauptete, dass die Hexenmeister den Geist der Orcs verunreinigten und diese tollkühne Invasion ihr Untergang wäre. Da Gul\'dan es nicht riskieren konnte, einen so populären Helden zu töten, musste er Durotan und seinen Frostwolfklan in entlegene Regionen dieser neuen Welt verbannen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1965, 'Als die verbannten Frostwolf durch das Portal gingen, schlossen sich nur wenige Klans der Orcs an. Diese Orcs errichteten in aller Hast einen Stützpunkt im schwarzen Morast, einem dunklen Sumpfgebiet weit im Osten des Königreichs Sturmwind. Als die Orcs ausströmten und die neuen Länder erforschten, ließen Konflikte mit den menschlichen Verteidigern von Sturmwind nicht lange auf sich warten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1966, 'Diese Scharmützel fanden zwar meist ein rasches Ende, machten aber Schwächen und Stärken der rivalisierenden Völker deutlich. Llane und Lothar konnten nie genaue Daten über die Zahl der Orcs sammeln und nur vermuten, welche Größe die Streitmacht hatte, mit der sie es zu tun bekommen würden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1967, 'Nach einigen Jahren war die Mehrzahl der orcischen Horde nach Azeroth aufgebrochen und Gul\'dan schien die Zeit für den entscheidenden Schlag gegen die Menschheit gekommen. Die Horde schlug mit aller Macht gegen das ahnungslose Königreich Sturmwind zu.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1968, 'Als die Streitkräfte von Azeroth und die Horde überall im Königreich aufeinander prallten, forderten interne Konflikte beider Armeen ihren Tribut. König Llane, der es nicht für möglich hielt, dass die bestialischen Orcs Azeroth erobern könnten, hielt geringschätzig die Stellung in seiner Hauptstadt Sturmwind. Lothar indessen kam zu der Überzeugung, dass der Kampf im Feindesland ausgetragen werden sollte, und musste sich zwischen seiner Überzeugung und seiner Loyalität zum König entscheiden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1969, 'Lothar beschloss, seinen Instinkten zu folgen, und erstürmte mit Hilfe des jungen Zauberlehrlings Khadgar Medivhs Turmfestung Karazhan. Es gelang Khadgar und Lothar, den besessenen Wächter zu besiegen, in dem sie die Ursache des Konflikts sahen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1970, 'Als Lothar und der junge Lehrling Medivhs Körper töteten, verbannten sie den Geist von Sargeras unwissentlich in den Abgrund. Als Folge konnte auch der reine, tugendhafte Geist von Medivh weiterleben... und wanderte viele Jahre durch die Astralebene.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1971, 'Medivh war zwar besiegt, doch die Horde blieb den Verteidigern von Sturmwind weiter überlegen. Als der Sieg der Horde näher rückte, erkannte Orgrim Schicksalshammer, einer der größten Häuptlinge der Orcs, endlich die Verrohung und Verderbnis, die seit der Zeit auf Draenor über die Klans gekommen war.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1972, 'Durotan, sein alter Weggefährte, kehrte aus der Verbannung zurück und warnte ihn erneut vor Gul\'dans Verrat. Gul\'dans Vergeltung folgte auf den Fuß. Seine Auftragsmörder töteten Durotan und dessen Familie und ließen nur seinen Sohn, noch ein Kleinkind, am Leben. Schicksalshammer wusste nicht, dass Aedelas Schwarzmoor, ein Offizier der Menschen, dieses Kleinkind, Durotans Sohn, fand und als Sklaven behielt. $B$BDieser kleine Orc sollte eines Tages zum größten Führer werden, den sein Volk je gekannt hatte.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1973, 'Orgrim setzte, durch Durotans Tod erbost, alles daran, die Horde von der dämonischen Verderbnis zu befreien und übernahm schließlich die Rolle eines Kriegshäuptlings der Horde, indem er Gul\'dans korrupte Marionette Schwarzfaust beseitigte. Unter seiner entschlossenen Führung begann die gnadenlose Horde schließlich mit der Belagerung der Burg Sturmwind.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1974, 'König Llane hatte die Macht der Horde drastisch unterschätzt und musste hilflos mit ansehen, wie sein Königreich den grünhäutigen Invasoren in die Hände fiel. Schließlich fiel König Llane durch die Hand einer der besten Mörderinnen des Schattenrates: der Halborcfrau Garona.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1975, 'Lothar und seine aus Karazhan heimkehrenden Krieger hegten die Hoffnung, sie könnten das Blutvergießen beenden und ihre einst ruhmreiche Heimat retten. Doch sie kehrten zu spät zurück und fanden nur noch schwelende Ruinen in ihrem geliebten Königreich. Die orcische Horde verheerte weiter das Land und forderte die umliegenden Ländereien für sich. Lothar und seine Gefährten mussten sich verstecken und schworen einen grimmigen Eid, ihre Heimat um jeden Preis zurückzuerobern.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1976, 'Lord Lothar scharte die Überreste der Armeen Azeroths nach der Niederlage bei der Burg Sturmwind um sich und begann einen gewaltigen Exodus über das Meer ins nördliche Königreich Lordaeron. In der festen Überzeugung, dass die Horde die gesamte Menschheit unterwerfen würde, sofern man ihr keinen Einhalt gebot, trafen sich die Anführer der sieben Menschennationen und vereinten ihre Völker zur Allianz von Lordaeron.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1977, 'Zum ersten Mal seit fast dreitausend Jahren wurden die entzweiten Nationen von Arathor wieder unter einem Banner vereinigt. Lord Lothar, der Oberkommandierende der Streitmacht der Allianz, bereitete seine Armeen auf die Ankunft der Horde vor.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1978, 'Mit Unterstützung seiner Offiziere Uther Lichtbringer, Admiral Daelin Prachtmeer und Turalyon konnte Lothar auch die halbmenschlichen Völker Lordaerons von der drohenden Gefahr überzeugen. Die Allianz sicherte sich die Unterstützung der stoischen Zwerge von Eisenschmiede und einer kleinen Zahl Hochelfen aus Quel\'Thalas.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1979, 'Die Elfen, die zu jener Zeit von Anasterian Sonnenwanderer geführt wurden, interessierten sich kaum für den bevorstehenden Konflikt. Aber sie waren verpflichtet, Lothar zu helfen, denn er war der letzte Nachfahre des Geschlechts der Arathi, das den Elfen in früheren Zeiten beigestanden hatte.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1980, 'Die Horde stand zu dieser Zeit unter dem Kommando von Kriegshäuptling Schicksalshammer. Sie brachte Oger von ihrer Heimatwelt Draenor herbei und konnte auch die neutralen Waldtrolle von Amani auf ihre Seite ziehen. Daraufhin begann die Horde einen gewaltigen Feldzug mit dem Ziel, das Zwergenkönigreich Khaz Modan und die südlichen Ausläufer von Lordaeron zu unterwerfen, und dezimierte mühelos jegliche Opposition.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1981, 'Die epischen Schlachten des Zweiten Krieges reichten von groß angelegten Scharmützeln zur See bis zu verlustreichen Materialschlachten in der Luft. Irgendwo hatte die Horde ein mächtiges Artefakt namens Dämonenseele gefunden und damit die alte Drachenkönigin Alexstrasza versklavt. Die Horde drohte, sie würde Alexstraszas kostbare Eier zerstören, und zwang sie so, ihre erwachsenen Kinder in den Krieg zu schicken. Die edlen roten Großdrachen sahen keinen anderen Ausweg, als für die Horde zu kämpfen, und so kämpften sie.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1982, 'Der Krieg tobte auf den Kontinenten Khaz Modan, Lordaeron und Azeroth selbst. Als Teil ihres Feldzugs im Norden brannte die Horde das Grenzland von Quel\'Thalas nieder und sorgte so dafür, dass die Elfen die Sache der Allianz endgültig unterstützten. Im Verlauf des Konflikts wurden auch die größeren Städte und Metropolen Lordaerons verwüstet. Lothar und seinen Verbündeten gelang es jedoch die Feinde auf Distanz zu halten, obwohl keine Verstärkung eintraf und sie zahlenmäßig unterlegen waren.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1983, 'Dann aber brach in den letzten Tagen des Zweiten Krieges, als der Sieg der Horde über die Allianz schon fast sicher schien, ein schrecklicher Zwist zwischen den beiden mächtigsten Orcs von Azeroth aus. Als Schicksalshammer gerade das letzte Gefecht gegen die Hauptstadt von Lordaeron vorbereitete - ein Angriff, der den kläglichen Resten der Allianz den Todesstoß versetzt hätte -, verließen Gul\'dan und seine Anhänger ihre Posten und stachen in See.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1984, 'Der bestürzte Schicksalshammer, der durch Gul\'dans Verrat fast die Hälfte seiner Streitmacht verloren hatte, war zum Rückzug gezwungen und verlor damit seine größte Chance auf einen Sieg über die Allianz.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1985, 'Der machtgierige Gul\'dan, darauf versessen, Gottstatus zu erlangen, begann eine verzweifelte Suche nach dem versunkenen Grabmal von Sargeras, in dem er das Geheimnis der höchsten Allmacht verborgen glaubte. Gul\'dan, der seine orcischen Mitstreiter bereits dazu verdammt hatte, Sklaven der Brennenden Legion zu werden, dachte nicht weiter an seine Verpflichtung gegenüber Schicksalshammer.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1986, 'Mit Unterstützung der Klans der Sturmrächer und des Schattenhammerklans gelang es Gul\'dan, das Grabmal von Sargeras vom Meeresboden emporsteigen zu lassen. Als er jedoch die alte, überflutete Gruft öffnete, warteten dort nur wahnsinnige Dämonen auf ihn.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1987, 'Schicksalshammer trachtete derweil danach, die pflichtvergessenen Orcs für ihren Verrat zu bestrafen, und schickte seine Streitmacht los, Gul\'dan zu töten und die Abtrünnigen wieder zurückzubringen. Für seine Tollkühnheit wurde Gul\'dan von den wahnsinnigen Dämonen, die er befreit hatte, in Stücke gerissen. Nach dem Tod ihres Anführers unterlagen die abtrünnigen Klans Schicksalshammers wütenden Legionen schon nach kurzer Zeit.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1988, 'Die Rebellion war damit zwar niedergeschlagen, doch gelang es der Horde nicht, sich von den schrecklichen Verlusten zu erholen, die sie erlitten hatte. Gul\'dans Verrat hatte der Allianz nicht nur Hoffnung gegeben, sondern auch die Zeit, sich neu zu formieren und Vergeltung zu üben.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1989, 'Lord Lothar begriff sehr schnell, dass Unstimmigkeiten die Horde entzweiten, scharte seine letzten Truppen um sich und drängte Schicksalshammer nach Süden zurück ins verwüstete Zentrum von Sturmwind. Dort kesselte die Streitmacht der Allianz den Rest der Horde in der vulkanischen Festung Schwarzfelsspitze ein. Lord Lothar fiel zwar am Fuße der Schwarzfelsspitze im Kampf, doch sein getreuer Mitstreiter Turalyon scharte die Kräfte der Allianz zur elften Stunde um sich und trieb die Horde in die tiefen Sümpfe des Elends.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1990, 'Es gelang Turalyons Streitkräften, das Dunkle Portal zu zerstören - jenes mystische Portal, das für die Orcs die Verbindung zu ihrer Heimatwelt Draenor darstellte. Nachdem die Horde damit von Verstärkung aus Draenor abgeschnitten war und durch interne Unstimmigkeiten gelähmt wurde, hatte sie der mächtigen Allianz nichts mehr entgegenzusetzen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1991, 'Die verstreuten Orcklans wurden schnell zusammengetrieben und in Internierungslager gesperrt. Es schien nun zwar, als wäre die Horde endgültig besiegt, aber viele blieben skeptisch, ob der Friede wohl von Dauer sein würde. Khadgar, inzwischen ein berühmter Erzmagier, brachte das Oberkommando der Allianz dazu, die Festung Nethergarde zu bauen, um die Ruinen des Dunklen Portals zu bewachen und zu gewährleisten, dass keine weiteren Invasionen von Draenor aus erfolgten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1992, 'Kaum waren die lodernden Feuer des Zweiten Krieges erloschen, da leitete die Allianz aggressive Schritte ein, um die Gefahr durch die Orcs einzugrenzen. Im Süden von Lordaeron wurde eine Anzahl großer Internierungslager für die gefangenen Orcs erbaut. Diese von den Paladinen und Soldatenveteranen der Allianz bewachten Lager erwiesen sich als großer Erfolg.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1993, 'Die gefangenen Orcs waren zwar nervös und brannten darauf, wieder zu kämpfen, doch den verschiedenen Lageraufsehern, deren Basis sich in der alten Gefängnisfestung Durnholde befand, gelang es, Frieden und einen Anschein von Ordnung zu erhalten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1994, 'Doch auf der Höllenwelt Draenor bereitete eine neue Orcarmee einen Feldzug gegen die ahnungslose Allianz vor. Ner\'zhul, ehedem Mentor von Gul\'dan, vereinte die verbliebenen Orcklans unter seinem dunklen Banner. Mit Unterstützung des Schattenmondklans hatte der alte Schamane die Absicht, auf Draenor eine Anzahl von Portalen zu öffnen, die die Horde zu neuen, unberührten Welten führen sollten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (1995, 'Als Energiequellen für diese Portale benötigte er einige verzauberte Artefakte aus Azeroth. Um sie in seinen Besitz zu bringen, öffnete Ner\'zhul das Dunkle Portal wieder und schickte seine gierigen Diener hindurch.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2019, 'Eine große Streitmacht der Orcs jedoch streifte noch immer ohne Wissen der Allianz frei durch die nördlichen Wüsten von Khaz Modan. Der Drachenmaulklan unter Führung des berüchtigten Hexenmeisters Nekros kontrollierte mit Hilfe eines alten Artefakts namens \"Dämonenseele\" die Drachenkönigin Alexstrasza und ihren Drachenschwarm. Mit der Drachenkönigin als Geisel stellte Nekros in der verlassenen - und, wie manche behaupten, verfluchten - Wildhammerfestung Grim Batol heimlich eine Armee auf.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2020, 'Nekros hatte vor, seine Streitmacht und die mächtigen roten Großdrachen gegen die Allianz ins Feld zu schicken, und hegte die Hoffnung, die Horde damit wieder zu vereinen und die Eroberung von Azeroth fortzusetzen. Seine Vision freilich wurde nicht Wirklichkeit: Einer kleinen Schar von Widerstandskämpfern unter dem Menschenmagier Rhonin gelang es, die Dämonenseele zu zerstören und die Drachenkönigin aus Nekros\' Bann zu befreien.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2021, 'In ihrer Wut zerstörten Alexstraszas Großdrachen Grim Batol bis auf die Grundmauern und äscherten den größten Teil des Drachenmaulklans ein. Nekros\' hochfliegende Pläne der Wiedervereinigung waren endgültig gescheitert, als Truppen der Allianz die überlebenden Orcs zusammentrieben und in die wartenden Internierungslager warfen. Die Niederlage des Drachenmaulklans bedeutete das Ende der Horde und des wütenden Kampfrausches der Orcs.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2022, 'Monate vergingen und immer mehr Orcs wurden gefangen genommen und in die Internierungslager gesteckt. Aufgrund zunehmender Überfüllung der Lager war die Allianz gezwungen, neue Lager auf den Ebenen südlich des Alteracgebirges zu erbauen. Damit er die ständig wachsende Anzahl der Lager ordentlich unterhalten und versorgen konnte, erhob König Terenas eine neue Steuer von den Nationen der Allianz.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2023, 'Neben steigenden politischen Spannungen wegen Grenzstreitigkeiten sorgte speziell diese neue Steuer für zunehmende Unruhe. Es hatte den Anschein, als würde der Pakt, der die Nationen der Menschen in ihrer dunkelsten Stunde zusammengeschweißt hatte, jeden Moment zerbrechen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2024, 'Inmitten des politischen Aufruhrs bemerkten zahlreiche Lageraufseher eine beunruhigende Veränderung an den gefangenen Orcs. Im Laufe der Zeit hatten Fluchtversuche und selbst Kämpfe unter den Gefangenen deutlich nachgelassen. Die Orcs wurden in zunehmendem Maße verschroben und lethargisch.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2025, 'Es war kaum zu glauben, aber die Orcs - die einst als das aggressivste Volk auf Azeroth betrachtet worden waren - schienen ihren Kampfeswillen vollkommen eingebüßt zu haben. Diese seltsame Lethargie stellte die Führer der Allianz vor Rätsel und forderte zunehmend Tribut unter immer schwächer werdenden Orcs.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2026, 'Spekulationen, wonach eine seltsame, nur auf Orcs übertragbare Krankheit die merkwürdige Lethargie bewirkte, machten die Runde. Doch Erzmagier Antonidas von Dalaran stellte eine andere Hypothese auf. Antonidas erforschte das Wenige, das man über die Geschichte der Orcs wusste, und fand heraus, dass sie seit Generationen bereits unter dem verderblichen Einfluss dämonischer Mächte standen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2027, 'Er mutmaßte, dass die Orcs schon vor der ersten Invasion von Azeroth von diesen Mächten missbraucht worden waren. Dämonen hatten ganz eindeutig das Blut der Orcs verunreinigt, was den Bestien wiederum unnatürlich übersteigerte Stärke, Belastbarkeit und Aggression bescherte.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2028, 'Antonidas stellte die Theorie auf, dass die allgemeine Lethargie der Orcs keine Krankheit, sondern die Folge einer Reaktion auf den Entzug jener vergänglichen Hexenmeistermagien war, die sie zu furchteinflößenden, blutrünstigen Kriegern gemacht hatte.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2029, 'Die Symptome waren zwar klar, doch gelang es Antonidas nicht, ein Heilmittel für den momentanen Zustand der Orcs zu finden. Viele seiner Magierkollegen vertraten ohnehin die Meinung, dass es nicht klug wäre, ein Heilmittel für die Orcs zu suchen. Einige angesehene Führer der Allianz stimmten dem zu. Antonidas machte sich weiter Gedanken über den rätselhaften Zustand der Orcs und kam zu dem Ergebnis, dass nur eine spirituelle Heilung in Frage käme.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2030, 'Aedelas Schwarzmoor, der oberste Aufseher der Internierungslager, wachte in seiner Gefängnisfestung Durnholde über die gefangenen Orcs. Einem bestimmten Orc galt sein besonderes Interesse: dem Waisenkind, das er fast achtzehn Jahre zuvor gefunden hatte. Schwarzmoor hatte den jungen Orc als seinen Lieblingssklaven aufgezogen und ihm den Namen Thrall gegeben. Schwarzmoor brachte dem Orc alles über Taktik, Philosophie und Kampf bei. Thrall wurde sogar zum Gladiator ausgebildet. Die ganze Zeit über versuchte der verderbte Aufseher, aus dem Orc eine lebende Waffe zu machen.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2109, 'Prachtmeers Armada stellt eine schwere Bedrohung für die Stabilität der Region dar. Als gefeierter Held des Zweiten Krieges war Jainas Vater ein unerbittlicher Gegner der Horde und fest entschlossen, Durotar dem Erdboden gleichzumachen, bevor die Orcs in dem Land Fuß fassen konnten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2110, 'Der Großadmiral stellte Jaina vor eine schreckliche Wahl: ihn im Kampf gegen die Orcs zu unterstützen und ihre neuen Verbündeten zu verraten oder den eigenen Vater zu bekämpfen und den brüchigen Frieden zu erhalten, den Allianz und Horde endlich erreicht hatten. Nach langem und gründlichem Nachdenken entschied sich Jaina für Letzteres und half Thrall, ihren hasserfüllten Vater zu besiegen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2111, 'Leider fiel Admiral Prachtmeer im Kampf, bevor Jaina sich mit ihm aussöhnen oder beweisen konnte, dass die Orcs keine blutgierigen Monster mehr waren. Als Dank für ihre Loyalität ließen die Orcs Jainas Streitmacht unbehelligt nach Theramore zurückkehren.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2130, 'Leider fiel Admiral Proudmoore im Kampf, bevor Jaina sich mit ihm aussöhnen oder beweisen konnte, dass die Orcs keine blutgierigen Monster mehr waren. Als Dank für ihre Loyalität liessen die Orcs Jainas Streitmacht unbehelligt nach Theramore zurückkehren.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2131, 'Throm-ka, Krieger. Ihr braucht mir gar nicht mit Geschichten von Euren ach so großen Taten zu kommen. Das ist Schnee von gestern. In letzter Zeit ein paar Menschen umgebracht? Nicht besonders viele, jede Wette! Ihr lasst nach. Ohne eine anständige Herausforderung verweichlicht Ihr.$B$BIch brauche Hilfe und, ganz egal, was die anderen Kriecher sagen, Euch mangelt es an der Ausbildung, die ich Euch geben kann. Falls das irgendwann in Euren dicken Schädel einsickert, warte ich unter dem Vordach vor dem Höhlenbau auf Euch.$B$B- Frang, Kriegerlehrer');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2150, 'Throm-ka, Krieger. Ihr braucht mir gar nicht mit Geschichten von Euren ach so großen Taten zu kommen. Das ist Schnee von gestern. In letzter Zeit ein paar Menschen umgebracht? Nicht besonders viele, jede Wette! Ihr lasst nach. Ohne eine anständige Herausforderung verweichlicht Ihr.$B$BIch brauche Hilfe und, ganz egal, was die anderen Kriecher sagen, Euch mangelt es an der Ausbildung, die ich Euch geben kann. Falls das irgendwann in Euren dicken Schädel einsickert, warte ich unter dem Vordach vor dem Höhlenbau auf Euch.$B$B- Frang, Kriegerlehrer');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2151, 'Arellas Feuerlaub$BHochhexer des Scharlachroten Kreuzzugs $BBürger von Quel\'Thalas $BIn ewigem Kampf mit dem Totenbeschwörer Diesalven gefangen');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2152, 'Admiral Barean Westwind$BGroßadmiral der Scharlachroten Flotte $BBürger von Kul Tiras$BVor der gefrorenen Küste von Nordend verschollen');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2153, 'Dorgar Steinbraue$BKrieger des Scharlachroten Kreuzzugs $BLord der roten Höhlen $BWurde zuletzt in den Bergen von Alterac gesehen');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2170, 'Dorgar Steinbraue$BKrieger des Scharlachroten Kreuzzugs$BLord der roten Höhlen$BWurde zuletzt in den Bergen von Alterac gesehen');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2171, 'Fellari Flinkpfeil$BWaldläuferhauptmann des Scharlachroten Kreuzzugs $BBürger von Quel\'Thalas $BIn den Wäldern von Silberwald verschollen');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2172, 'Ferren Marcus$BHochabt des Scharlachroten Klosters $BBürger von Stratholme $BFiel bei der Verteidigung des Scharlachroten Klosters im ersten Sommerzeitangriff');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2173, 'Harthal Klarblick$BLordpaladin des Scharlachroten Kreuzzugs $BBürger von Azeroth - Ritter der Silberhand$BWurde zuletzt gesehen, wie er die verfluchte Stadt Stratholme betrat');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2174, 'Holia Sonnenschild$BVerteidigerin des Scharlachroten Kreuzzugs$BStarb, als sie den Schreckenslord Beltheris erschlug');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2175, 'Invar Einarm$BErster leitender Auftragsmörder des Scharlachroten Kreuzzugs $BBürger von Dalaran$BWurde zuletzt an der Küste von Nordend gesehen');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2176, 'Orman von Stromgarde$BErster Großgeneral des Scharlachroten Kreuzzugs $BBürger von Stromgarde$BAm Zugang zum Eiskronegletscher verschollen');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2178, 'Yana Blutspeer$BZweite leitende Auftragsmörderin des Scharlachroten Kreuzzugs $BBürgerin von Dalaran  $BIn Tirisfal verschollen');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2190, 'Valea Zwillingsschneid$BKriegerin des Scharlachroten Kreuzzugs$BBürgerin von Alterac$BWurde zuletzt in den östlichen Pestländern gesehen');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2191, 'Vor rund 16.000 Jahren (lange bevor die Nachtelfen törichterweise den Zorn der Brennenden Legion beschworen) herrschten die Trolle über den größten Teil von Kalimdor (das damals noch ein einziger Kontinent war). Es gab zwei Trollreiche, das Reich der Gurubashi im südöstlichen Dschungel und das Reich Amani in den zentralen Wäldern.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2192, 'Es gab kleinere Stämme, die weit im Norden lebten (in der Region, die wir als Nordend kennen). Die Stämme gründeten eine kleine Nation, die Gundrak hieß, aber nie Größe oder Wohlstand der südlichen Reiche erlangte.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2193, 'Die Reiche Gurubashi und Amani hegten keine Sympathien füreinander, führten aber selten Krieg. Zu jener Zeit war ein drittes Reich ihr größter gemeinsamer Feind - die Zivilisation Azj\'Aqir. Die Aqir waren intelligente Insektoiden, die die Länder weit im Westen beherrschten. Diese intelligenten Insektoiden waren enorm expansionistisch und unglaublich böse. Zwanghaft wollten die Aqir alles Leben, ausgenommen Insekten, von den Feldern Kalimdors tilgen.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2610, 'Nutzt die Macht des Amuletts der Geister, um sie zu zwingen, Gestalt anzunehmen, und nehmt ihnen dann die Edelsteine ab! Platziert die Edelsteine dann im Amulett der Geister und bringt es mir. Sobald ich das Amulett der Vereinigung habe, bin ich mächtig genug, um die Stämme zu reformieren, damit wir endlich so sind, wie unsere Vorfahren uns haben wollten!');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2611, '... und so werdet Ihr das legendäre Schwert Aschenbringer des Scharlachroten Hochlords finden.$B$BErstaunlich in was man beim Fischen alles reingeraten kann, nicht?');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2630, '... und so werdet Ihr das legendäre Schwert Aschenbringer des Scharlachroten Hochlords finden.$B$BErstaunlich in was man beim Fischen alles reingeraten kann, nicht?');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2631, '<Die Seiten sind mit alten Elfenrunen bedeckt.>\n$BAuf diesen Seiten finden sich Erinnerungen an Ereignisse, die sich bei der Sammlung und Herstellung der zur Anfertigung von großem Arkanum erforderlichen Reagenzien zutrugen.$B$BMöge dieser Buchband niemals in die Hände unserer Feinde geraten. $B$BMöge ich dereinst wieder das fahle Licht des Mondes auf Quel\'Thalas scheinen sehen.$B$BMöge ich zum Ruhme von Kael\'thas sterben.$B$BMöge ich zum Ruhme Illidans töten.$B$B- Meister Kariel Winthalus');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2632, '<Ihr könnt die Schrift auf diesen Seiten nicht entziffern.>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2633, '<Die Seiten sind mit alten Elfenrunen bedeckt.>\n$BAuf diesen Seiten finden sich Erinnerungen an Ereignisse, die sich bei der Sammlung und Herstellung der zur Anfertigung von großem Arkanum erforderlichen Reagenzien zutrugen.$B$BMöge dieser Buchband niemals in die Hände unserer Feinde geraten. $B$BMöge ich dereinst wieder das fahle Licht des Mondes auf Quel\'Thalas scheinen sehen.$B$BMöge ich zum Ruhme von Kael\'thas sterben.$B$BMöge ich zum Ruhme Illidans töten.$B$B- Meister Kariel Winthalus');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2634, '<Die Tinte wirbelt und verändert sich überall auf der Seite. Es ist, als ob das Buch Euch verspotten möchte.>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2635, '<Die Seiten sind mit alten Elfenrunen bedeckt.>\n$BAuf diesen Seiten finden sich Erinnerungen an Ereignisse, die sich bei der Sammlung und Herstellung der zur Anfertigung von großem Arkanum erforderlichen Reagenzien zutrugen.$B$BMöge dieser Buchband niemals in die Hände unserer Feinde geraten. $B$BMöge ich dereinst wieder das fahle Licht des Mondes auf Quel\'Thalas scheinen sehen.$B$BMöge ich zum Ruhme von Kael\'thas sterben.$B$BMöge ich zum Ruhme Illidans töten.$B$B- Meister Kariel Winthalus');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2636, '<Ihr fühlt einen stechenden Schmerz wenn Ihr auf diese Seiten blickt.>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2637, '...versteckt Euch unter einem Felsvorsprung oder einer Brücke, wenn in Reichweite. Eine gute, starke Mauer ist auch eine sichere Sache.$B$B$B<mehr verblasster Text.>\n$BBenutzt v lst nd g Heilung, zwischen fünf und fünfzehn Kl r r.$B$B$B<mehr verblasster Text.>\n$BAm Ende eines erfolgreichen Schlachtzugs, lehnt Euch zurück und genießt den Sieg. Nach ganzen zehn bis fünfzehn Sekunden, begebt Euch in die Stadt und zeigt Eure f t e B te, damit\'s alle sehen und Euch verehren können.$B$B$B<Ein kurzer Blick auf den Rest des Kompendiums lässt Euch mit Kopfschmerzen zurück.>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2653, '<Ihr fühlt einen stechenden Schmerz wenn Ihr auf diese Seiten blickt.>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2654, '<HTML>\n<BODY>\n<H1 align=\"center\">ABHANDLUNG MILITÄRISCHER RÄNGE</H1>\n<BR/>\n<BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRankAlliance\" align=\"left\"/>\n<BR/>\n<P align=\"right\">Es folgen</P>\n<P align=\"right\">die militärischen Ränge</P>\n<P align=\"right\">der Allianz,</P>\n<P align=\"right\">gefolgt von</P>\n<P align=\"right\">Informationen die</P>\n<P align=\"right\">den Völkern</P>\n<P align=\"right\">der Horde bekannt sind. Alle</P>\n<P align=\"right\">Angaben sind in zwei</P>\n<P align=\"right\">Abschnitte unterteilt, Offiziere und Soldaten. Dabei werden ihre Ränge jeweils in absteigender Reihenfolge aufgelistet, vom höchsten bis zum niedrigsten Rang. Lang lebe die Allianz!</P>\n</BODY>\n</HTML>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2655, '<HTML>\n<BODY>\n<H1 align=\"center\">OFFIZIERSRÄNGE DER ALLIANZ</H1><BR/>\n<P align=\"center\"Teil 1</P>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank14\" align=\"left\"/><BR/>\n<P align=\"right\">Großmarschall</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank13\" align=\"left\"/><BR/>\n<P align=\"right\">Feldmarschall</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank12\" align=\"left\"/><BR/>\n<P align=\"right\">Marschall</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank11\" align=\"left\"/><BR/>\n<P align=\"right\">Rittmeister</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank10\" align=\"left\"/><BR/>\n<P align=\"right\">Feldkommandant</P><BR/><BR/>\n</BODY>\n</HTML>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2656, '<HTML>\n<BODY>\n<H1 align=\"center\">OFFIZIERSRÄNGE DER ALLIANZ</H1><BR/>\n<P align=\"center\"Teil 2</P>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank09\" align=\"left\"/><BR/>\n<P align=\"right\">Ritter der Allianz</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank08\" align=\"left\"/><BR/>\n<P align=\"right\">Kürassier</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank07\" align=\"left\"/><BR/>\n<P align=\"right\">Hauptmann</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank06\" align=\"left\"/><BR/>\n<P align=\"right\">Leutnant</P><BR/><BR/>\n</BODY>\n</HTML>');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2657, '<HTML>\n<BODY>\n<H1 align=\"center\">SOLDATENRÄNGE DER ALLIANZ</H1><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank05\" align=\"left\"/><BR/>\n<P align=\"right\">Fähnrich</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank04\" align=\"left\"/><BR/>\n<P align=\"right\">Feldwebel</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank03\" align=\"left\"/><BR/>\n<P align=\"right\">Landsknecht</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank02\" align=\"left\"/><BR/>\n<P align=\"right\">Fußknecht</P><BR/><BR/>\n<IMG src=\"Interface\\PvPRankBadgesPvPRank01\" align=\"left\"/><BR/>\n<P align=\"right\">Gefreiter</P><BR/><BR/>\n</BODY>\n</HTML>');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2659, 'Blickt Ihr in das Auge, erfüllen Bilder eines großen Kampfes Euren Geist.$B$BDieser furchteinflößende Konflikt scheint irgendwo in Lordaeron stattzufinden.$B$BIhr könnt nur schwerlich eine einzelne, weibliche Silhouette ausmachen, die inmitten tausender von Leichen steht und eine Heerschar der Geißel abwehrt. Sie ist hoffnungslos unterlegen.$B$BFäden des Lichts entströmen ihren Händen und schneiden durch hunderte von Untoten.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2666, 'Völlig umsonst, könnte man annehmen. Einige Augenblicke später wird die Priesterin von einem Schwarm toter Arbeiter umzingelt... Die Gefallenen sind wieder auferstanden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2671, 'Simone die Verführerin:$B$BFindet Simone beim Besudeln des Krater von Un\'Goros. Lasst Euch von Ihrer Verkleidung nicht täuschen. Nähert Euch mit Bedacht und fordert sie zum Kampf heraus.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2672, 'Klinfran der Wahnsinnige:$B$BKlinfran zieht durch die brennende Steppe. Nähert Euch ihm mit Bedacht und zwingt ihn Euch seine wahre Form zu zeigen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2673, 'Solenor der Schlächter:$B$BIn der trockenen Landschaft von Silithus lauert der Feind, Solenor der Schlächter. Zweifellos verkleidet, definitiv eine Gefahr. Nähert Euch ihm und zwingt ihn zur Verwandlung.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2674, 'Artorius der Verhängnisvolle:$B$BArtorius bringt über alles was er in Winterspring berührt Verderben und den Untergang. Findet ihn, tötet ihn.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2675, 'Lasst Euch gewarnt sein, $R, diese Dämonen muss man auf ihre eigene Weise bekämpfen. Haben sie das Gefühl Euch nicht übertreffen zu können, werden sie fliehen.$B$BGEHT ALLEINE.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2676, '<HTML>\n<BODY>\n<H1 align=\"center\">MILITÄRISCHE RÄNGE DER ALLIANZ</H1>\n<BR/>\n<P align=\"center\"OFFIZIERE</P>\n<BR/>\n<P align=\"center\"Großmarschall</P>\n<P align=\"center\"Feldmarschall</P>\n<P align=\"center\"Marschall</P>\n<P align=\"center\"Rittmeister</P>\n<P align=\"center\"Feldkommandant</P>\n<P align=\"center\"Ritter der Allianz</P>\n<P align=\"center\"Kürassier</P>\n<P align=\"center\"Hauptmann</P>\n<P align=\"center\"Leutnant</P>\n<BR/>\n<P align=\"center\"SOLDATEN</P>\n<BR/>\n<P align=\"center\"Fähnrich</P>\n<P align=\"center\"Feldwebel</P>\n<P align=\"center\"Landsknecht</P>\n<P align=\"center\"Fußknecht</P>\n<P align=\"center\"Gefreiter</P>\n</BODY>\n</HTML>');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2771, 'Schrittweise zum Sieg$BDer ultimative Leitfaden zum schnellen Sieg über die Stormpike$B-Von Drek\'Thar$B$BAuf den folgenden Seiten findet Ihr eine Abhandlung über Kampftaktiken und Politik. Der erfahrene Soldat verlässt sich auf sein Wissen. Möge Euch dieses Buch in der Schlacht um das Alteractal leiten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2772, 'Kapitel 1 - Die Front$B$BDer Kampf gegen die Stormpike lässt sich am ehesten mit dem Schälen einer Zwiebel vergleichen. Um an den Kern zu gelangen, müssen zunächst die äußeren Schichten entfernt werden.$B$BDie vordersten Frontlinien setzen sich zumeist aus Gebirgsjägern der Stormpike und Schildwachen der Allianz zusammen, welche allesamt vom Stonehearth-Bunker aus befehligt werden. Oberkommandierende und zuständig für die Verstärkung dieser Einheiten im Falle eines Angriffs ist Captain Balinda Stonehearth. Schaltet Captain Stonehearth aus und die Frontlinien werden zusammenbrechen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2773, 'Kapitel 2 - Die Zwillingstürme$B$BMacht nicht den Fehler, Vanndar Stormpike zu unterschätzen, er ist ein brillianter Taktiker. Auch wenn Ihr die erste Frontlinie überwunden habt, müsst Ihr noch die sekundäre Verteidigungsstellung zerstören. Diese besteht aus den Zwillingstürmen von Stonehearth und Icewing. Von dort aus werden auch die Stompike-Gardisten rund um Dun Baldar, sowie alle Patrouillen der Stormpike befehligt.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2774, 'Seid wachsam, Soldat. Beide Türme werden schwer bewacht und unterstehen jeweils einem von Vanndars Elitekommandanten. Sollte es Euren Streitkräften gelingen die Verteidigungsanlagen der Türme zu durchbrechen stellt sicher, dass der Befehlshabende Kommandant... für immer schweigt. Ein weiterer Schritt zum Sieg über die Stormpike ist getan.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2775, 'Kapitel 3 - Die vier Kommandanten$B$BDie dritte Schicht der Stormpike-Zwiebel besteht aus den vier Kommandanten. Was diesen Punkt anbelangt, hat Vanndar unsere glorreiche Verteidungsstrategie hervorragend kopiert. Sicher würde er Euch was anderes erzählen... aber ich weiß es besser.$B$BDie vier Kommandanten koordinieren den Einsatz der Stormpikegarde, welche Dun Baldar bis zum letzten Mann verteidigen wird. Schaltet sie aus und die Gardisten der Stormpike werden fallen.$B$BNun wartet die letzte Schicht darauf gepellt zu werden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2776, 'Kapitel 4 - Die Bunker von Dun Baldar$B$BWie Ihr es sicherlich schon festgestellt habt, sollen die Verteidigungsringe der Stormpike es unmöglich machen, deren gesamte Armee mit einem Schlag auszulöschen. Um Eurer Frage vorzubeugen - ja, es stimmt das unsere Verteidigung nach exakt dem gleichen Muster aufgebaut ist und nein, ich werde unsere Verteidungsaufstellung nicht verändern. Der Feind hat uns kopiert und nicht wir ihn!');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2777, 'Wo war ich stehengeblieben? Richtig, die Bunker von Dun Baldar (welche sich natürlich in Dun Baldar befinden) kontrollieren die Stormpike-Verteidiger - Vanndars zuverlässigste Eliteeinheit. Zerstört die beiden Bunker und die zu Vanndars Unterstützung herangebrachten Verstärkungen werden aufhören zu existieren.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2846, 'Ich hoffe innigst, dass ich mit Hilfe meiner Untersuchungen eine zusätzliche Quelle magischer Energie ausfindig machen und für meine Leute sichern kann. Wir müssen einen Weg finden, wie wir ohne den Sonnenbrunnen unsere Lebensweise fortführen können und dabei nicht der Verlockung arkaner Magien erliegen.$B$BIch glaube, dass die Zukunft der Sin\'dorei allen erneut als leuchtendes Beispiel dienen kann!');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2847, 'Bis jetzt hatten wir kein Glück. Das Bisschen Magie, zu dem ich direkten Zugang habe, muss durch den Turm kanalisiert werden. Ich habe jedoch ein paar außergewöhnliche Ideen. Ich werde meine besten Lehrlinge damit beauftragen, diesen Anhaltspunkten nachzugehen. Wir werden sehen, was dabei herauskommt.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2947, 'Für diese Expedition habe ich Ajeck Rouack und Sire S. J. Erlgadin um mich geschart. Zudem steht mir mein getreuer Diener Barnil Steinkrug zur Seite. Ich habe an der Seite von Ajecks Vater gar manche Schlacht zur Verteidigung der Allianz gefochten. Sie jetzt erwachsen zu sehen, berührt mich eigentümlich. Ihr Vater hat sie gut in der Waffenkunst unterrichtet. Sie geht so geschickt mit dem Bogen um, dass ich mich frage, ob Elfenblut in ihren Adern fließt.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2948, 'Sire S. J. Erlgadin entstammt dem menschlichen Adel. Sein Vater war der für seine Großzügigkeit bekannte Graf Erlgadin. Der Graf war es, der sich während des Wiederaufbaus von Sturmwind nach dem Zweiten Großen Krieg für bessere Arbeitsbedingungen für die Steinmetzgilde einsetzte.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2950, 'Wir standen beim ersten Sonnenstrahl auf. Barnil machte das Frühstück. Mir fiel auf, dass Ajeck irgendwie irritiert wirkte. Wir hatten einen langen Weg vor uns und unsere Jagd versprach, ziemlich gefährlich zu werden. Eine einzige Unachtsamkeit konnte schlimme Folgen haben. Doch Ajeck konnte ihren Blick anscheinend nicht von Barnil wenden, der am Flussufer ein paar Sachen abwusch.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2952, 'Wir gingen Richtung Westen durch das Dickicht des Urwalds. Langsam und vorsichtig bahnten wir uns auf der Suche nach Beute unseren Weg durch das Unterholz. Der Morgen verging und nichts passierte. Nicht einmal ein Lufthauch regte sich im Tal. Bis zum Nachmittag hatte sich Unruhe in unserer Expedition breit gemacht. Barnil ließ es an der für einen Jäger so wichtigen Vorsicht mangeln. Er stapfte ziemlich ungeschickt vor sich hin und trat oft auf trockenes Laub oder herabgefallene Zweige.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2953, 'Nach einem solchen Fehltritt legte Erlgadin Barnil die Hand schwer auf die Schulter. Ajeck und ich schauten beiläufig. Wir dachten, Erlgadin würde Barnil ob seiner Unvorsichtigkeit endlich einmal die Leviten lesen. Aber Erlgadin wies mit einer langsamen Kopfbewegung in Richtung eines umgestürzten Baumes ganz in der Nähe. Zwei stechend schwarze Augen über einem Maul voller rasiermesserscharfer Zähne starrten uns an.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2954, 'Es handelte sich um einen männlichen Schlingendorntiger. Ehe ich auch nur nach meiner Büchse greifen konnte, hatte Erlgadin schon einen Armbrustbolzen abgefeuert. Der Bolzen verfehlte sein Ziel und traf den Tiger nur in der linken Flanke. Er versuchte zu fliehen, aber die Wunde war zu schwer. Das Wildtier taumelte noch einige Sekunden angeschlagen herum, ehe Barnil ihm mit seiner Wurfaxt den Gnadenstoß versetzte.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2957, 'Ich hatte meinen Begleitern versprochen, dass wir am nächsten Tag Panther jagen würden, da deren Felle in Azeroth sehr gefragt sind. Diese Nachfrage lässt sich nur damit erklären, dass all die fähigen Jäger, Fallensteller und Pelzhändler fort sind und ihr Leben im Namen der Allianz lassen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2958, 'Ajeck und Sire Erlgadin waren ganz erpicht darauf zu lernen, wie man Zwergengewehre einsetzt. Daher hatte ich die beiden Menschen angewiesen, ihre primitiven Distanzwaffen im Stützpunkt zu lassen. Barnil und ich statteten sie also mit den besten Feuerwaffen aus Eisenschmiede aus.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2959, 'Wir hielten uns nach Süden und folgten einigen frischen Pantherspuren. Kurz darauf kamen wir an eine Klamm, die von einer phantastischen Hängebrücke überspannt wurde. Ich musste sofort an Branns eindrucksvolle Beschreibungen des Gebiets denken, als ich dieses technische Wunderwerk sah. Es wurde oft behauptet, die einheimischen Trolle seien primitiv und ungebildet, doch als ich auf dieses handwerkliche Meisterwerk blickte, erkannte ich mit einem Mal das außerordentliche Können, mit dem die Erbauer der Trolle das schier unüberwindliche Hindernis überwunden hatten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2960, 'Bald darauf spürte Ajeck im Südwesten den Panther auf. Leise schlichen wir weiter, die Flinten im Anschlag. Das Knacken von Zweigen im Unterholz ließ uns aufhorchen. Da war etwas. Ein Blick genügte, um mich mit Barnil zu verständigen. Er nahm langsam die Flinte herunter. Dieser Abschuss war nicht für uns bestimmt; er sollte unseren menschlichen Freunden gehören. Unzählige Panther waren schon von unseren Flinten zur Strecke gebracht worden. Dieser hier würde von den Menschen erlegt.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2961, 'Ajeck und Sire Erlgadin standen unbeweglich und hielten ihre Flinten auf das dichte Buschwerk unter den sanft schwingenden Bäumen gerichtet. Die Mittagssonne brannte auf uns nieder. Ein kleiner Schweißtropfen rann an Erlgadins Schläfe herab, als er den Hahn spannte. In dem Moment, als der Hahn einrastete, teilte sich mit einem Mal das Dickicht und ein großer schwarzer Panther - ein schönes Exemplar - preschte hervor.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2962, 'Die Menschen nahmen den Panther aufs Korn, während dieser am Waldrand entlanglief. Die Läufe ihrer Flinten bewegten sich absolut synchron. Barnil warf mir einen drängenden Blick zu, aber ich schüttelte verneinend den Kopf. Diese Jagd war für die Menschen und nicht für Barnil und mich. Erlgadin feuerte, doch er verfehlte den Panther. Auf den starken Rückstoß des Gewehrs war er nicht gefasst.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2963, 'Die Büchse ruckte heftig zurück. Er verriss den Schuss seitwärts und geriet mit dem Lauf just unter Ajecks Flinte. Ajeck ihrerseits hatte genau diesen Moment abgepasst, um abzudrücken. Der Schuss verirrte sich irgendwo in die Bäume. Ein Schwarm Vögel flog kreischend aus dem Blätterdach auf und flatterte aufgeregt in alle Himmelsrichtungen davon. Eine Wolke Pulverdampf stieg über einem Baum auf. Fassungslos sahen wir mit an, wie ein gewaltiger Ast geradewegs auf den flüchtenden Panther fiel und ihm das Rückgrat brach.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2964, 'Im Laufe der Wochen vergrößerte sich unser Bestand an Panther- und Tigerfellen immens. Daher entschied ich, dass wir uns einem neuen Ziel zuwenden sollten: Raptoren.$BSo dankbar die Menschen auch für die Schießübungen waren, die Barnil und ich mit ihnen machten, sie wollten doch von der Benutzung der Feuerwaffen Abstand nehmen. Ajeck kam mit ihrem fein gearbeiteten Bogen weit besser zurecht und Sire Erlgadin verließ das Lager ohnehin nie ohne seine stabile Armbrust.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2965, 'Wir machten uns beim ersten Tageslicht in Richtung Süden zu den Tkashi-Ruinen auf. Barnil äußerte sich besorgt, dass wir auf Mitglieder des Blutskalpstamms treffen könnten. Ich erinnerte ihn daran, dass die Blutskalpe mehr mit der Vernichtung des verfeindeten Schädelspalterstamms beschäftigt waren. Ich brauche wohl nicht zu betonen, dass Barnil alles andere als beruhigt war. Ich für mein Teil vertraute jedoch auf meine geladene Flinte, einen Ranzen Schießpulver und die drei versierten Jäger neben mir und machte mir keine Gedanken über einen möglichen Hinterhalt.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2966, 'Ich stand vor einer riesigen Höllenbestie auf dem Schlachtfeld und die Armee der Brennenden Legion näherte sich von allen Seiten. Dagegen wirkt eine Bande Trolle so harmlos wie ein Kaninchen in den Hügeln von Dun Morogh.$B$BWir passierten die Tkashi-Ruinen ohne Zwischenfall, worüber insbesondere Barnil sehr erleichtert war. Die Gruppe ging weiter westwärts Richtung Großes Meer und streifte die Ruinen von Zul\'Kunda im Süden. Als wir die Steilküste erklommen, sahen wir ihn: unseren ersten Raptor.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2967, 'Das Tier nahm uns noch nicht einmal wahr. Das Einzige, was es von der Expedition mitbekam, war eine Kugel zwischen seinen Augen.$B$BSire Erlgadin ließ ein herzliches \"Hurra!\" ertönen und Ajeck nickte mir anerkennend zu. Ich kramte in meiner Tasche, weil ich mir zur Feier des Tages ein Pfeifchen gönnen wollte. Barnil kletterte die Anhöhe hinauf, um den Kadaver des Raptors zu holen. Äußerst zufrieden betrachtete ich das tote Vieh.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2968, 'Die Freude über den Erfolg währte jedoch nicht lange. Denn als ich zum Horizont blickte, sah ich auf dem Hügel genau über dem armen Barnil gleich mehrere Silhouetten.$B$B\"Lauf, Barnil!\", schrie ich. Ajeck, Sire Erlgadin und ich feuerten aus allen Rohren auf die heranstürmenden Raptoren und deckten sie mit Kugeln, Pfeilen und Bolzen ein. Einer der Raptoren ging tödlich getroffen zu Boden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2969, 'Unsere hastig abgefeuerten Schüsse ermöglichten Barnil die Flucht. Barnil stolperte den Hügel wieder hinunter und schloss sich uns erneut an. Wir schlugen uns in den Urwald, wobei das Rudel Schmetterschwanzraptoren jede unserer Bewegungen genau verfolgte.$B$BAus Jägern waren Gejagte geworden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2970, 'Ich führte die Gruppe in Richtung Meer und hoffte, dass wir an der Küste Schutz vor den Raptoren finden würden. Doch in unserer Hast waren wir zu weit nach Norden abgekommen und befanden uns auf einer gefährlich hohen Erhebung. Das war ein Fehler. Und ich war schuld. Plötzlich standen wir vor steil abfallenden Klippen, die Raptoren nur noch ein paar Schritte hinter uns.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2971, 'Ich trat langsam mit erhobener Flinte vor. Ich hatte diese mutigen Jäger ins Verderben geführt. Also wollte ich auch bei ihrer Verteidigung sterben. Schmetterschwanzraptoren sind besonders angriffslustig und bekannt für ihren unstillbaren Blutdurst. Zudem waren sie uns zahlenmäßig weit überlegen. Doch ich wollte verdammt sein, wenn sie mich und meine Kameraden töten könnten, ohne dabei selbst Verluste zu erleiden.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2972, 'Ajeck und Sire Erlgadin machten ihre Waffen bereit und gaben mir seitlich Deckung, während wir mit dem Rücken zum Wasser standen. Barnil seufzte ergeben und zog seine Axt. Die Schmetterschwanzraptoren waren schon ganz nah. Sie wurden langsamer. Sie pirschten sich an ihre Beute heran, wussten sie doch, dass wir ihnen nicht mehr entkommen konnten.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2973, 'Da geschah das Unglaubliche: Neben uns hörten wir plötzlich das erschreckende Gebrüll des großen weißen Tigers. Augenblicklich drehten die Raptoren ab und stoben in alle Richtungen davon. Wir sahen nur einen weißen Blitz, als der Tiger an uns vorbeischoss und sich auf einen der Raptoren stürzte. Befehle waren unnötig. Wir alle vier wussten, dass es galt, die Beine in die Hand zu nehmen.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2974, 'Wir rannten so schnell es ging und ohne Pause zurück zum Basislager. Abends saßen wir noch lange still ums Lagerfeuer herum, wussten wir doch nur zu gut, dass wir unser Leben allein einer merkwürdigen Wendung des Schicksals zu verdanken hatten. Das sind die Risiken eines Großwildjägers. Man spielt mit dem Schicksal, wenn man es herausfordert. Und doch bekommt jeder von uns irgendwann die messerscharfen Zähne seines Schicksals zu spüren. Dieser Zwerg hier ist einfach nur froh, dass dieser Augenblick ihn nicht auf den grünen Hügeln des Schlingendorntals ereilt hat.$B$B- Ende -');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2975, 'Dummkopf,$B$BSuchen Essen. Blau schmecken gut. Lantresor sagen ist in Ordnung. Bring Essen zurück zu Brocken. Brocken zuerst essen, dann Dummkopf essen. Ok? Gehen schnell oder Brocken essen dich.$B$B-Brocken');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2976, '(1) Raliq der Betrunkene: Oger. Er verlässt nie Wirtshaus. Gemein. Hässlich. Fett. Gemein. Und sehr fett.$B$B[Nächste Seite]');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2977, '(2) Kusch\'kusch: Dieser kleine lästige Sporenmann aus den Zangarmarschen hat Pilzgarten an Grenze zwischen Zangarmarschen und Terokkar. Hat viele Gold an Sal\'salabim verloren bei Spiel \"Was riecht hier so\". Hat versucht Sal\'salabim mit dummem Pilz namens Glühkappe zu bezahlen. Sagt ist so gut wie Gold! Hah!$B$B[Nächste Seite]');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2978, '(3) Floon: Arakkoa. Hat viele Gold an Sal\'salabim verloren. Sal\'salabim hat Vogelmann getötet weil nicht gezahlt hat. Jetzt Geistervogelmann läuft herum in nordwestlichem Teil von Knochenwüste.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2979, 'Die Olembawurzel ist eine ziemlich gewöhnliche Wurzel in den Wäldern von Terokkar. Sucht in der Nähe der Olembabäume, die einen Großteil des Waldes einnehmen, nach herausragenden Wurzeln.$B$BDie Marschenbeere wächst ausschließlich in den Zangamarschen. Man kann sie nur bei der Festung der Ango\'rosh im Nordwesten der Marschen finden. Hütet Euch vor den Ogern, die die wertvollen Beeren wie Schießhunde bewachen.$B$BDer Telaarifarn ist wohl von den Kräutern auf dieser Liste am leichtesten zu pflücken. Ihr findet ihn südlich von Garadar im Telaaribecken. Er wächst gewöhnlich am Wasser.$B$BDas letzte Kraut auf der Liste wächst ausschließlich im Schergrat. Den Schergrat findet Ihr nördlich der Zangarmarschen. Drachenwirbel wächst am Ende der zerklüfteten Felsformationen, die die Schlucht des Schergrats begrenzen. Ihr werdet wissen, wovon ich spreche, wenn Ihr erstmal den Schergrat gesehen habt. Die Felsformationen sehen aus wie Reihen über Reihen von scharfen, spitzen Zähnen.');
...
INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2993, 'Mein verehrter Kanzler,$B$Bdie Aufgabe, die Riesen von Schattenmond für unsere Sache zu gewinnen, liegt nun in Euren fähigen Händen. Lasst Euren Blutelfencharme spielen, damit sie Dinge so wie ich sehen. Sollte dies nicht funktionieren, dann löscht sie alle ein für alle Mal aus...$B$B-Fürst Illidan Sturmgrimm');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2994, 'Ein Paladin muss in allen Dingen das Licht widerspiegeln, das uns Kraft gibt. Wenn einer unserer Art nach dem Göttlichen strebt, bedeutet das nicht, dass er ein Gott sein möchte... wir trachten nur danach, in allem nur Gutes zu tun.');

INSERT INTO locales_page_text
   (`entry`, `Text_loc3`)
VALUES
   (2995, 'Auch wenn Ihr in diesen schweren Zeiten berufen seid, das Böse zu zerschmettern, dürft Ihr nicht vergessen, dass die Unterstützung anderer Euch wahrhaft von den anderen Bürgern unterscheidet. Mitgefühl, Geduld, Tapferkeit... das alles bedeutet einem Paladin so viel wie Kraft im Kampf.$B$BBedenket das und vergesst es niemals.');
